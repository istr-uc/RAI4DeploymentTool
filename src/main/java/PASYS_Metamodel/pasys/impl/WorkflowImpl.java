 ...
 * </p>
 * <ul>
 * <li>{@link PASYS_Metamodel.pasys.impl.WorkflowImpl#getArtifactName
 * <em>Artifact Name</em>}</li>
 * <li>{@link PASYS_Metamodel.pasys.impl.WorkflowImpl#getArtifactLocator
 * <em>Artifact Locator</em>}</li>
 * <li>{@link PASYS_Metamodel.pasys.impl.WorkflowImpl#getArguments
 * <em>Arguments</em>}</li>
 * <li>{@link PASYS_Metamodel.pasys.impl.WorkflowImpl#getScriptFolderPath
 * <em>Script Folder Path</em>}</li>
 * <li>{@link PASYS_Metamodel.pasys.impl.WorkflowImpl#getConfigFolderPath
 * <em>Config Folder Path</em>}</li>
 * <li>{@link PASYS_Metamodel.pasys.impl.WorkflowImpl#getDataFolderPath <em>Data
 * Folder Path</em>}</li>
 * <li>{@link PASYS_Metamodel.pasys.impl.WorkflowImpl#getLogFolderPath <em>Log
 * Folder Path</em>}</li>
 * <li>{@link PASYS_Metamodel.pasys.impl.WorkflowImpl#isIsRunning <em>Is
 * Running</em>}</li>
 * <li>{@link PASYS_Metamodel.pasys.impl.WorkflowImpl#getOwnedStreamData
 * <em>Owned Stream Data</em>}</li>
 * <li>{@link PASYS_Metamodel.pasys.impl.WorkflowImpl#getOwnedTasks <em>Owned
 * Tasks</em>}</li>
 * <li>{@link PASYS_Metamodel.pasys.impl.WorkflowImpl#getRootTask <em>Root
 * Task</em>}</li>
 * <li>{@link PASYS_Metamodel.pasys.impl.WorkflowImpl#getOwnedTaskExecutors
 * <em>Owned Task Executors</em>}</li>
 * <li>{@link PASYS_Metamodel.pasys.impl.WorkflowImpl#getScheduler
 * <em>Scheduler</em>}</li>
 * <li>{@link PASYS_Metamodel.pasys.impl.WorkflowImpl#getOwnedMeters <em>Owned
 * Meters</em>}</li>
 * </ul>
 *
 * @generated
...
public class WorkflowImpl extends SystemElementImpl implements Workflow {
	/**
	 * The default value of the '{@link #getArtifactName() <em>Artifact
	...
	/**
	 * The cached value of the '{@link #getArtifactName() <em>Artifact
	 * Name</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getArtifactName()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getArtifactLocator() <em>Artifact
	 * Locator</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getArtifactLocator() <em>Artifact
	 * Locator</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getArtifactLocator()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getScriptFolderPath() <em>Script Folder
	...
	/**
	 * The cached value of the '{@link #getScriptFolderPath() <em>Script Folder
	 * Path</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getScriptFolderPath()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getConfigFolderPath() <em>Config Folder
	 * Path</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getConfigFolderPath() <em>Config Folder
	 * Path</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getConfigFolderPath()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getDataFolderPath() <em>Data Folder
	 * Path</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getDataFolderPath() <em>Data Folder
	 * Path</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getDataFolderPath()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getLogFolderPath() <em>Log Folder
	 * Path</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getLogFolderPath() <em>Log Folder
	 * Path</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getLogFolderPath()
	 * @generated
	...
	/**
	 * The default value of the '{@link #isIsRunning() <em>Is Running</em>}'
	...
	/**
	 * The cached value of the '{@link #isIsRunning() <em>Is Running</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isIsRunning()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getOwnedStreamData() <em>Owned Stream
	...
	/**
	 * The cached value of the '{@link #getOwnedTasks() <em>Owned Tasks</em>}'
	...
	/**
	 * The cached value of the '{@link #getRootTask() <em>Root Task</em>}'
	...
	/**
	 * The cached value of the '{@link #getOwnedTaskExecutors() <em>Owned Task
	 * Executors</em>}' containment reference list. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getScheduler() <em>Scheduler</em>}'
	 * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getScheduler()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getOwnedMeters() <em>Owned Meters</em>}'
	 * containment reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getOwnedMeters()
	 * @generated
	...
	public void setArtifactName(String newArtifactName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PasysPackage.WORKFLOW__ARTIFACT_NAME, oldArtifactName,
					artifactName));
	}
	...
	public void setArtifactLocator(String newArtifactLocator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PasysPackage.WORKFLOW__ARTIFACT_LOCATOR,
					oldArtifactLocator, artifactLocator));
	}
	...
	public void setScriptFolderPath(String newScriptFolderPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PasysPackage.WORKFLOW__SCRIPT_FOLDER_PATH,
					oldScriptFolderPath, scriptFolderPath));
	}
	...
	public void setConfigFolderPath(String newConfigFolderPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PasysPackage.WORKFLOW__CONFIG_FOLDER_PATH,
					oldConfigFolderPath, configFolderPath));
	}
	...
	public void setDataFolderPath(String newDataFolderPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PasysPackage.WORKFLOW__DATA_FOLDER_PATH,
					oldDataFolderPath, dataFolderPath));
	}
	...
	public void setLogFolderPath(String newLogFolderPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PasysPackage.WORKFLOW__LOG_FOLDER_PATH,
					oldLogFolderPath, logFolderPath));
	}
	...
	public void setIsRunning(boolean newIsRunning) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PasysPackage.WORKFLOW__IS_RUNNING, oldIsRunning,
					isRunning));
	}
	...
	public EList<WorkflowStreamData> getOwnedStreamData() {
		if (ownedStreamData == null) {
			ownedStreamData = new EObjectContainmentWithInverseEList<WorkflowStreamData>(WorkflowStreamData.class, this,
					PasysPackage.WORKFLOW__OWNED_STREAM_DATA, PasysPackage.WORKFLOW_STREAM_DATA__OWNER);
		}
	...
	public EList<Task> getOwnedTasks() {
		if (ownedTasks == null) {
			ownedTasks = new EObjectContainmentWithInverseEList<Task>(Task.class, this,
					PasysPackage.WORKFLOW__OWNED_TASKS, PasysPackage.TASK__OWNER);
		}
		return ownedTasks;
	}
	...
	public Task getRootTask() {
		if (rootTask != null && rootTask.eIsProxy()) {
			...
			if (rootTask != oldRootTask) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PasysPackage.WORKFLOW__ROOT_TASK,
							oldRootTask, rootTask));
			}
		}
		return rootTask;
	}
	...
	public void setRootTask(Task newRootTask) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PasysPackage.WORKFLOW__ROOT_TASK, oldRootTask,
					rootTask));
	}
	...
	public SchedulingServer getScheduler() {
		if (scheduler != null && scheduler.eIsProxy()) {
			...
			if (scheduler != oldScheduler) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PasysPackage.WORKFLOW__SCHEDULER,
	...
	public NotificationChain basicSetScheduler(SchedulingServer newScheduler, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PasysPackage.WORKFLOW__SCHEDULER, oldScheduler, newScheduler);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setScheduler(SchedulingServer newScheduler) {
		if (newScheduler != scheduler) {
			...
			if (scheduler != null)
				msgs = ((InternalEObject) scheduler).eInverseRemove(this, PasysPackage.SCHEDULING_SERVER__WORKFLOWS,
						SchedulingServer.class, msgs);
			if (newScheduler != null)
				msgs = ((InternalEObject) newScheduler).eInverseAdd(this, PasysPackage.SCHEDULING_SERVER__WORKFLOWS,
						SchedulingServer.class, msgs);
			msgs = basicSetScheduler(newScheduler, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PasysPackage.WORKFLOW__SCHEDULER, newScheduler,
					newScheduler));
	}
	...
	public EList<WorkflowLatencyMeter> getOwnedMeters() {
		if (ownedMeters == null) {
			ownedMeters = new EObjectContainmentWithInverseEList<WorkflowLatencyMeter>(WorkflowLatencyMeter.class, this,
					PasysPackage.WORKFLOW__OWNED_METERS, PasysPackage.WORKFLOW_LATENCY_METER__OWNER);
		}
		return ownedMeters;
	}
	...
	public EList<TaskExecutor> getOwnedTaskExecutors() {
		if (ownedTaskExecutors == null) {
			ownedTaskExecutors = new EObjectContainmentWithInverseEList<TaskExecutor>(TaskExecutor.class, this,
					PasysPackage.WORKFLOW__OWNED_TASK_EXECUTORS, PasysPackage.TASK_EXECUTOR__OWNER);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case PasysPackage.WORKFLOW__OWNED_TASK_EXECUTORS:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getOwnedTaskExecutors()).basicAdd(otherEnd,
					msgs);
	...
	public boolean eIsSet(int featureID) {
		...
		case PasysPackage.WORKFLOW__ARTIFACT_LOCATOR:
			return ARTIFACT_LOCATOR_EDEFAULT == null ? artifactLocator != null
					: !ARTIFACT_LOCATOR_EDEFAULT.equals(artifactLocator);
		case PasysPackage.WORKFLOW__ARGUMENTS:
			return arguments != null && !arguments.isEmpty();
		case PasysPackage.WORKFLOW__SCRIPT_FOLDER_PATH:
			return SCRIPT_FOLDER_PATH_EDEFAULT == null ? scriptFolderPath != null
					: !SCRIPT_FOLDER_PATH_EDEFAULT.equals(scriptFolderPath);
		case PasysPackage.WORKFLOW__CONFIG_FOLDER_PATH:
			return CONFIG_FOLDER_PATH_EDEFAULT == null ? configFolderPath != null
					: !CONFIG_FOLDER_PATH_EDEFAULT.equals(configFolderPath);
		case PasysPackage.WORKFLOW__DATA_FOLDER_PATH:
			return DATA_FOLDER_PATH_EDEFAULT == null ? dataFolderPath != null
					: !DATA_FOLDER_PATH_EDEFAULT.equals(dataFolderPath);
		case PasysPackage.WORKFLOW__LOG_FOLDER_PATH:
			return LOG_FOLDER_PATH_EDEFAULT == null ? logFolderPath != null
					: !LOG_FOLDER_PATH_EDEFAULT.equals(logFolderPath);
		case PasysPackage.WORKFLOW__IS_RUNNING:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == SystemComponent.class) {
			...
			case PasysPackage.WORKFLOW__ARTIFACT_NAME:
				return PasysPackage.SYSTEM_COMPONENT__ARTIFACT_NAME;
			case PasysPackage.WORKFLOW__ARTIFACT_LOCATOR:
				return PasysPackage.SYSTEM_COMPONENT__ARTIFACT_LOCATOR;
			case PasysPackage.WORKFLOW__ARGUMENTS:
				return PasysPackage.SYSTEM_COMPONENT__ARGUMENTS;
			case PasysPackage.WORKFLOW__SCRIPT_FOLDER_PATH:
				return PasysPackage.SYSTEM_COMPONENT__SCRIPT_FOLDER_PATH;
			case PasysPackage.WORKFLOW__CONFIG_FOLDER_PATH:
				return PasysPackage.SYSTEM_COMPONENT__CONFIG_FOLDER_PATH;
			case PasysPackage.WORKFLOW__DATA_FOLDER_PATH:
				return PasysPackage.SYSTEM_COMPONENT__DATA_FOLDER_PATH;
			case PasysPackage.WORKFLOW__LOG_FOLDER_PATH:
				return PasysPackage.SYSTEM_COMPONENT__LOG_FOLDER_PATH;
			case PasysPackage.WORKFLOW__IS_RUNNING:
				return PasysPackage.SYSTEM_COMPONENT__IS_RUNNING;
			default:
				return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == SystemComponent.class) {
			...
			case PasysPackage.SYSTEM_COMPONENT__ARTIFACT_NAME:
				return PasysPackage.WORKFLOW__ARTIFACT_NAME;
			case PasysPackage.SYSTEM_COMPONENT__ARTIFACT_LOCATOR:
				return PasysPackage.WORKFLOW__ARTIFACT_LOCATOR;
			case PasysPackage.SYSTEM_COMPONENT__ARGUMENTS:
				return PasysPackage.WORKFLOW__ARGUMENTS;
			case PasysPackage.SYSTEM_COMPONENT__SCRIPT_FOLDER_PATH:
				return PasysPackage.WORKFLOW__SCRIPT_FOLDER_PATH;
			case PasysPackage.SYSTEM_COMPONENT__CONFIG_FOLDER_PATH:
				return PasysPackage.WORKFLOW__CONFIG_FOLDER_PATH;
			case PasysPackage.SYSTEM_COMPONENT__DATA_FOLDER_PATH:
				return PasysPackage.WORKFLOW__DATA_FOLDER_PATH;
			case PasysPackage.SYSTEM_COMPONENT__LOG_FOLDER_PATH:
				return PasysPackage.WORKFLOW__LOG_FOLDER_PATH;
			case PasysPackage.SYSTEM_COMPONENT__IS_RUNNING:
				return PasysPackage.WORKFLOW__IS_RUNNING;
			default:
				return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == SystemComponent.class) {
			...
			case PasysPackage.SYSTEM_COMPONENT___DEPLOY:
				return PasysPackage.WORKFLOW___DEPLOY;
			default:
				return -1;
			}
		}
