 ...
 * </p>
 * <ul>
 *   <li>{@link PASYS_Metamodel.pasys.impl.NodeDeploymentConfImpl#getArguments <em>Arguments</em>}</li>
 *   <li>{@link PASYS_Metamodel.pasys.impl.NodeDeploymentConfImpl#getArtifactLocator <em>Artifact Locator</em>}</li>
 *   <li>{@link PASYS_Metamodel.pasys.impl.NodeDeploymentConfImpl#getArtifactName <em>Artifact Name</em>}</li>
 *   <li>{@link PASYS_Metamodel.pasys.impl.NodeDeploymentConfImpl#getConfigFolderPath <em>Config Folder Path</em>}</li>
 *   <li>{@link PASYS_Metamodel.pasys.impl.NodeDeploymentConfImpl#getScriptFolderPath <em>Script Folder Path</em>}</li>
 *   <li>{@link PASYS_Metamodel.pasys.impl.NodeDeploymentConfImpl#getDataFolderPath <em>Data Folder Path</em>}</li>
 *   <li>{@link PASYS_Metamodel.pasys.impl.NodeDeploymentConfImpl#getLogFolderPath <em>Log Folder Path</em>}</li>
 *   <li>{@link PASYS_Metamodel.pasys.impl.NodeDeploymentConfImpl#getCodeFolderPath <em>Code Folder Path</em>}</li>
 *   <li>{@link PASYS_Metamodel.pasys.impl.NodeDeploymentConfImpl#isIsRunning <em>Is Running</em>}</li>
 * </ul>
 *
 * @generated
 */
