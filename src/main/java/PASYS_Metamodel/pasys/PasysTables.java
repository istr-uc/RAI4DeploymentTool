...
public class PasysTables extends AbstractTables
{
	...
	public static final /*@NonInvalid*/ ClassId CLSSid_Class = PasysTables.PACKid_$metamodel$.getClassId("Class", 0);
	...
	public static final /*@NonInvalid*/ ClassId CLSSid_NodeCluster = PasysTables.PACKid_www_unican_es_s_ISTR_s_P3forI4_s_pasys.getClassId("NodeCluster", 0);
	...
	public static final /*@NonInvalid*/ ClassId CLSSid_OrchestrationService = PasysTables.PACKid_www_unican_es_s_ISTR_s_P3forI4_s_pasys.getClassId("OrchestrationService", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_OrchestrationServiceDeploymentConf = PasysTables.PACKid_www_unican_es_s_ISTR_s_P3forI4_s_pasys.getClassId("OrchestrationServiceDeploymentConf", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_PlatformResource = PasysTables.PACKid_www_unican_es_s_ISTR_s_P3forI4_s_pasys.getClassId("PlatformResource", 0);
	...
	public static final /*@NonInvalid*/ ClassId CLSSid_ResourceCluster = PasysTables.PACKid_www_unican_es_s_ISTR_s_P3forI4_s_pasys.getClassId("ResourceCluster", 0);
	...
	public static final /*@NonInvalid*/ ClassId CLSSid_SystemAdapter = PasysTables.PACKid_www_unican_es_s_ISTR_s_P3forI4_s_pasys.getClassId("SystemAdapter", 0);
	...
	public static final /*@NonInvalid*/ ClassId CLSSid_SystemElementAdapter = PasysTables.PACKid_www_unican_es_s_ISTR_s_P3forI4_s_pasys.getClassId("SystemElementAdapter", 0);
	...
	public static final /*@NonInvalid*/ EnumerationId ENUMid_ExternalElementType = PasysTables.PACKid_www_unican_es_s_ISTR_s_P3forI4_s_pasys.getEnumerationId("ExternalElementType");
	...
	public static final /*@NonInvalid*/ EnumerationId ENUMid_SystemComponentType = PasysTables.PACKid_www_unican_es_s_ISTR_s_P3forI4_s_pasys.getEnumerationId("SystemComponentType");
	...
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_CassandraService = TypeId.BAG.getSpecializedId(PasysTables.CLSSid_CassandraService);
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_DerivedStreamData = TypeId.BAG.getSpecializedId(PasysTables.CLSSid_DerivedStreamData);
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_FlowStreamData = TypeId.BAG.getSpecializedId(PasysTables.CLSSid_FlowStreamData);
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_KafkaService = TypeId.BAG.getSpecializedId(PasysTables.CLSSid_KafkaService);
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_NetworkUtilization = TypeId.BAG.getSpecializedId(PasysTables.CLSSid_NetworkUtilization);
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_OrchestrationServiceDeploymentConf = TypeId.BAG.getSpecializedId(PasysTables.CLSSid_OrchestrationServiceDeploymentConf);
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_PlatformService = TypeId.BAG.getSpecializedId(PasysTables.CLSSid_PlatformService);
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_ProcessingNode = TypeId.BAG.getSpecializedId(PasysTables.CLSSid_ProcessingNode);
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_ProcessingNodeMemory = TypeId.BAG.getSpecializedId(PasysTables.CLSSid_ProcessingNodeMemory);
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_ProcessingNodeUtilization = TypeId.BAG.getSpecializedId(PasysTables.CLSSid_ProcessingNodeUtilization);
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_Rack = TypeId.BAG.getSpecializedId(PasysTables.CLSSid_Rack);
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_ResourceCluster = TypeId.BAG.getSpecializedId(PasysTables.CLSSid_ResourceCluster);
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_SchedulableSet = TypeId.BAG.getSpecializedId(PasysTables.CLSSid_SchedulableSet);
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_SparkService = TypeId.BAG.getSpecializedId(PasysTables.CLSSid_SparkService);
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_StormService = TypeId.BAG.getSpecializedId(PasysTables.CLSSid_StormService);
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_StreamDataPartition = TypeId.BAG.getSpecializedId(PasysTables.CLSSid_StreamDataPartition);
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_StreamDataRate = TypeId.BAG.getSpecializedId(PasysTables.CLSSid_StreamDataRate);
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_Task = TypeId.BAG.getSpecializedId(PasysTables.CLSSid_Task);
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_TaskExecutor = TypeId.BAG.getSpecializedId(PasysTables.CLSSid_TaskExecutor);
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_TaskProcessingAmount = TypeId.BAG.getSpecializedId(PasysTables.CLSSid_TaskProcessingAmount);
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_Workflow = TypeId.BAG.getSpecializedId(PasysTables.CLSSid_Workflow);
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_WorkflowLatency = TypeId.BAG.getSpecializedId(PasysTables.CLSSid_WorkflowLatency);
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_WorkloadStreamData = TypeId.BAG.getSpecializedId(PasysTables.CLSSid_WorkloadStreamData);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_ArtifactDescriptor = TypeId.ORDERED_SET.getSpecializedId(PasysTables.CLSSid_ArtifactDescriptor);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_DataCenter = TypeId.ORDERED_SET.getSpecializedId(PasysTables.CLSSid_DataCenter);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_DeploymentFileDescriptor = TypeId.ORDERED_SET.getSpecializedId(PasysTables.CLSSid_DeploymentFileDescriptor);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_ExporterData = TypeId.ORDERED_SET.getSpecializedId(PasysTables.CLSSid_ExporterData);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_FileDescriptor = TypeId.ORDERED_SET.getSpecializedId(PasysTables.CLSSid_FileDescriptor);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_Meter = TypeId.ORDERED_SET.getSpecializedId(PasysTables.CLSSid_Meter);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_Network = TypeId.ORDERED_SET.getSpecializedId(PasysTables.CLSSid_Network);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_NodeHostedMeter = TypeId.ORDERED_SET.getSpecializedId(PasysTables.CLSSid_NodeHostedMeter);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_PlatformResource = TypeId.ORDERED_SET.getSpecializedId(PasysTables.CLSSid_PlatformResource);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_Port = TypeId.ORDERED_SET.getSpecializedId(PasysTables.CLSSid_Port);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_ProcessingNode = TypeId.ORDERED_SET.getSpecializedId(PasysTables.CLSSid_ProcessingNode);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_Rack = TypeId.ORDERED_SET.getSpecializedId(PasysTables.CLSSid_Rack);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_StreamData = TypeId.ORDERED_SET.getSpecializedId(PasysTables.CLSSid_StreamData);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_StreamDataPartition = TypeId.ORDERED_SET.getSpecializedId(PasysTables.CLSSid_StreamDataPartition);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_StreamRateMeter = TypeId.ORDERED_SET.getSpecializedId(PasysTables.CLSSid_StreamRateMeter);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_SystemAdapter = TypeId.ORDERED_SET.getSpecializedId(PasysTables.CLSSid_SystemAdapter);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_SystemElementAdapter = TypeId.ORDERED_SET.getSpecializedId(PasysTables.CLSSid_SystemElementAdapter);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_Task = TypeId.ORDERED_SET.getSpecializedId(PasysTables.CLSSid_Task);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_TaskExecutor = TypeId.ORDERED_SET.getSpecializedId(PasysTables.CLSSid_TaskExecutor);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_TaskProcessingAmountMeter = TypeId.ORDERED_SET.getSpecializedId(PasysTables.CLSSid_TaskProcessingAmountMeter);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_Volume = TypeId.ORDERED_SET.getSpecializedId(PasysTables.CLSSid_Volume);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_Workflow = TypeId.ORDERED_SET.getSpecializedId(PasysTables.CLSSid_Workflow);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_WorkflowLatencyMeter = TypeId.ORDERED_SET.getSpecializedId(PasysTables.CLSSid_WorkflowLatencyMeter);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_WorkflowStreamData = TypeId.ORDERED_SET.getSpecializedId(PasysTables.CLSSid_WorkflowStreamData);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_DATAid_EInt = TypeId.ORDERED_SET.getSpecializedId(PasysTables.DATAid_EInt);
	public static final /*@NonInvalid*/ CollectionTypeId SET_CLSSid_SystemElement = TypeId.SET.getSpecializedId(PasysTables.CLSSid_SystemElement);
	...
	public static class Types {
		...
		public static final EcoreExecutorEnumeration _ExternalElementType = new EcoreExecutorEnumeration(PasysPackage.Literals.EXTERNAL_ELEMENT_TYPE, PACKAGE, 0);
		...
		public static final EcoreExecutorType _KubernetesService = new EcoreExecutorType(PasysPackage.Literals.KUBERNETES_SERVICE, PACKAGE, 0);
		...
		public static final EcoreExecutorType _NodeCluster = new EcoreExecutorType(PasysPackage.Literals.NODE_CLUSTER, PACKAGE, 0);
		public static final EcoreExecutorType _NodeClusterDeploymentConf = new EcoreExecutorType(PasysPackage.Literals.NODE_CLUSTER_DEPLOYMENT_CONF, PACKAGE, 0);
		...
		public static final EcoreExecutorType _OrchestrationService = new EcoreExecutorType(PasysPackage.Literals.ORCHESTRATION_SERVICE, PACKAGE, 0 | ExecutorType.ABSTRACT);
		public static final EcoreExecutorType _OrchestrationServiceDeploymentConf = new EcoreExecutorType(PasysPackage.Literals.ORCHESTRATION_SERVICE_DEPLOYMENT_CONF, PACKAGE, 0);
		...
		public static final EcoreExecutorType _ResourceCluster = new EcoreExecutorType(PasysPackage.Literals.RESOURCE_CLUSTER, PACKAGE, 0);
		...
		public static final EcoreExecutorType _SwarmService = new EcoreExecutorType(PasysPackage.Literals.SWARM_SERVICE, PACKAGE, 0);
		public static final EcoreExecutorType _SystemAdapter = new EcoreExecutorType(PasysPackage.Literals.SYSTEM_ADAPTER, PACKAGE, 0);
		public static final EcoreExecutorEnumeration _SystemComponentType = new EcoreExecutorEnumeration(PasysPackage.Literals.SYSTEM_COMPONENT_TYPE, PACKAGE, 0);
		...
		public static final EcoreExecutorType _SystemElementAdapter = new EcoreExecutorType(PasysPackage.Literals.SYSTEM_ELEMENT_ADAPTER, PACKAGE, 0);
		public static final EcoreExecutorType _SystemExternalElement = new EcoreExecutorType(PasysPackage.Literals.SYSTEM_EXTERNAL_ELEMENT, PACKAGE, 0);
		...
		private static final EcoreExecutorType /*@NonNull*/ [] types = {
			...
			_NetworkUtilization,
			_NodeCluster,
			_NodeClusterDeploymentConf,
			_NodeHostedMeter,
			_NodeResourceMeter,
			_NodeScheduler,
			_OrchestrationService,
			_OrchestrationServiceDeploymentConf,
			_PersistenceService,
			...
			_SwarmService,
			_SystemAdapter,
			_SystemComponentType,
			_SystemElement,
			_SystemElementAdapter,
			_SystemExternalElement,
			_Task,
			_TaskExecutor,
	...
	public static class Fragments {
		...
		private static final ExecutorFragment _ExternalElementType__ExternalElementType = new ExecutorFragment(Types._ExternalElementType, PasysTables.Types._ExternalElementType);
		private static final ExecutorFragment _ExternalElementType__OclAny = new ExecutorFragment(Types._ExternalElementType, OCLstdlibTables.Types._OclAny);
		private static final ExecutorFragment _ExternalElementType__OclElement = new ExecutorFragment(Types._ExternalElementType, OCLstdlibTables.Types._OclElement);
		private static final ExecutorFragment _ExternalElementType__OclEnumeration = new ExecutorFragment(Types._ExternalElementType, OCLstdlibTables.Types._OclEnumeration);
		private static final ExecutorFragment _ExternalElementType__OclType = new ExecutorFragment(Types._ExternalElementType, OCLstdlibTables.Types._OclType);
		...
		private static final ExecutorFragment _KubernetesService__DeployableComponent = new ExecutorFragment(Types._KubernetesService, PasysTables.Types._DeployableComponent);
		private static final ExecutorFragment _KubernetesService__KubernetesService = new ExecutorFragment(Types._KubernetesService, PasysTables.Types._KubernetesService);
		private static final ExecutorFragment _KubernetesService__NamedElement = new ExecutorFragment(Types._KubernetesService, PasysTables.Types._NamedElement);
		private static final ExecutorFragment _KubernetesService__OclAny = new ExecutorFragment(Types._KubernetesService, OCLstdlibTables.Types._OclAny);
		private static final ExecutorFragment _KubernetesService__OclElement = new ExecutorFragment(Types._KubernetesService, OCLstdlibTables.Types._OclElement);
		private static final ExecutorFragment _KubernetesService__OrchestrationService = new ExecutorFragment(Types._KubernetesService, PasysTables.Types._OrchestrationService);
		private static final ExecutorFragment _KubernetesService__PlatformResource = new ExecutorFragment(Types._KubernetesService, PasysTables.Types._PlatformResource);
		private static final ExecutorFragment _KubernetesService__PlatformService = new ExecutorFragment(Types._KubernetesService, PasysTables.Types._PlatformService);
		private static final ExecutorFragment _KubernetesService__SystemElement = new ExecutorFragment(Types._KubernetesService, PasysTables.Types._SystemElement);
		...
		private static final ExecutorFragment _NodeCluster__NamedElement = new ExecutorFragment(Types._NodeCluster, PasysTables.Types._NamedElement);
		private static final ExecutorFragment _NodeCluster__NodeCluster = new ExecutorFragment(Types._NodeCluster, PasysTables.Types._NodeCluster);
		private static final ExecutorFragment _NodeCluster__OclAny = new ExecutorFragment(Types._NodeCluster, OCLstdlibTables.Types._OclAny);
		private static final ExecutorFragment _NodeCluster__OclElement = new ExecutorFragment(Types._NodeCluster, OCLstdlibTables.Types._OclElement);
		private static final ExecutorFragment _NodeCluster__PlatformResource = new ExecutorFragment(Types._NodeCluster, PasysTables.Types._PlatformResource);
		private static final ExecutorFragment _NodeCluster__ResourceCluster = new ExecutorFragment(Types._NodeCluster, PasysTables.Types._ResourceCluster);
		private static final ExecutorFragment _NodeCluster__SystemElement = new ExecutorFragment(Types._NodeCluster, PasysTables.Types._SystemElement);

		private static final ExecutorFragment _NodeClusterDeploymentConf__DeploymentConfiguration = new ExecutorFragment(Types._NodeClusterDeploymentConf, PasysTables.Types._DeploymentConfiguration);
		private static final ExecutorFragment _NodeClusterDeploymentConf__NodeClusterDeploymentConf = new ExecutorFragment(Types._NodeClusterDeploymentConf, PasysTables.Types._NodeClusterDeploymentConf);
		private static final ExecutorFragment _NodeClusterDeploymentConf__OclAny = new ExecutorFragment(Types._NodeClusterDeploymentConf, OCLstdlibTables.Types._OclAny);
		private static final ExecutorFragment _NodeClusterDeploymentConf__OclElement = new ExecutorFragment(Types._NodeClusterDeploymentConf, OCLstdlibTables.Types._OclElement);
		private static final ExecutorFragment _NodeClusterDeploymentConf__PlatformServiceDeploymentConf = new ExecutorFragment(Types._NodeClusterDeploymentConf, PasysTables.Types._PlatformServiceDeploymentConf);
		...
		private static final ExecutorFragment _OrchestrationService__DeployableComponent = new ExecutorFragment(Types._OrchestrationService, PasysTables.Types._DeployableComponent);
		private static final ExecutorFragment _OrchestrationService__NamedElement = new ExecutorFragment(Types._OrchestrationService, PasysTables.Types._NamedElement);
		private static final ExecutorFragment _OrchestrationService__OclAny = new ExecutorFragment(Types._OrchestrationService, OCLstdlibTables.Types._OclAny);
		private static final ExecutorFragment _OrchestrationService__OclElement = new ExecutorFragment(Types._OrchestrationService, OCLstdlibTables.Types._OclElement);
		private static final ExecutorFragment _OrchestrationService__OrchestrationService = new ExecutorFragment(Types._OrchestrationService, PasysTables.Types._OrchestrationService);
		private static final ExecutorFragment _OrchestrationService__PlatformResource = new ExecutorFragment(Types._OrchestrationService, PasysTables.Types._PlatformResource);
		private static final ExecutorFragment _OrchestrationService__PlatformService = new ExecutorFragment(Types._OrchestrationService, PasysTables.Types._PlatformService);
		private static final ExecutorFragment _OrchestrationService__SystemElement = new ExecutorFragment(Types._OrchestrationService, PasysTables.Types._SystemElement);

		private static final ExecutorFragment _OrchestrationServiceDeploymentConf__DeploymentConfiguration = new ExecutorFragment(Types._OrchestrationServiceDeploymentConf, PasysTables.Types._DeploymentConfiguration);
		private static final ExecutorFragment _OrchestrationServiceDeploymentConf__OclAny = new ExecutorFragment(Types._OrchestrationServiceDeploymentConf, OCLstdlibTables.Types._OclAny);
		private static final ExecutorFragment _OrchestrationServiceDeploymentConf__OclElement = new ExecutorFragment(Types._OrchestrationServiceDeploymentConf, OCLstdlibTables.Types._OclElement);
		private static final ExecutorFragment _OrchestrationServiceDeploymentConf__OrchestrationServiceDeploymentConf = new ExecutorFragment(Types._OrchestrationServiceDeploymentConf, PasysTables.Types._OrchestrationServiceDeploymentConf);
		private static final ExecutorFragment _OrchestrationServiceDeploymentConf__PlatformServiceDeploymentConf = new ExecutorFragment(Types._OrchestrationServiceDeploymentConf, PasysTables.Types._PlatformServiceDeploymentConf);
		...
		private static final ExecutorFragment _ResourceCluster__NamedElement = new ExecutorFragment(Types._ResourceCluster, PasysTables.Types._NamedElement);
		private static final ExecutorFragment _ResourceCluster__OclAny = new ExecutorFragment(Types._ResourceCluster, OCLstdlibTables.Types._OclAny);
		private static final ExecutorFragment _ResourceCluster__OclElement = new ExecutorFragment(Types._ResourceCluster, OCLstdlibTables.Types._OclElement);
		private static final ExecutorFragment _ResourceCluster__PlatformResource = new ExecutorFragment(Types._ResourceCluster, PasysTables.Types._PlatformResource);
		private static final ExecutorFragment _ResourceCluster__ResourceCluster = new ExecutorFragment(Types._ResourceCluster, PasysTables.Types._ResourceCluster);
		private static final ExecutorFragment _ResourceCluster__SystemElement = new ExecutorFragment(Types._ResourceCluster, PasysTables.Types._SystemElement);
		...
		private static final ExecutorFragment _SwarmService__DeployableComponent = new ExecutorFragment(Types._SwarmService, PasysTables.Types._DeployableComponent);
		private static final ExecutorFragment _SwarmService__NamedElement = new ExecutorFragment(Types._SwarmService, PasysTables.Types._NamedElement);
		private static final ExecutorFragment _SwarmService__OclAny = new ExecutorFragment(Types._SwarmService, OCLstdlibTables.Types._OclAny);
		private static final ExecutorFragment _SwarmService__OclElement = new ExecutorFragment(Types._SwarmService, OCLstdlibTables.Types._OclElement);
		private static final ExecutorFragment _SwarmService__OrchestrationService = new ExecutorFragment(Types._SwarmService, PasysTables.Types._OrchestrationService);
		private static final ExecutorFragment _SwarmService__PlatformResource = new ExecutorFragment(Types._SwarmService, PasysTables.Types._PlatformResource);
		private static final ExecutorFragment _SwarmService__PlatformService = new ExecutorFragment(Types._SwarmService, PasysTables.Types._PlatformService);
		private static final ExecutorFragment _SwarmService__SwarmService = new ExecutorFragment(Types._SwarmService, PasysTables.Types._SwarmService);
		private static final ExecutorFragment _SwarmService__SystemElement = new ExecutorFragment(Types._SwarmService, PasysTables.Types._SystemElement);

		private static final ExecutorFragment _SystemAdapter__OclAny = new ExecutorFragment(Types._SystemAdapter, OCLstdlibTables.Types._OclAny);
		private static final ExecutorFragment _SystemAdapter__OclElement = new ExecutorFragment(Types._SystemAdapter, OCLstdlibTables.Types._OclElement);
		private static final ExecutorFragment _SystemAdapter__SystemAdapter = new ExecutorFragment(Types._SystemAdapter, PasysTables.Types._SystemAdapter);

		private static final ExecutorFragment _SystemComponentType__OclAny = new ExecutorFragment(Types._SystemComponentType, OCLstdlibTables.Types._OclAny);
		private static final ExecutorFragment _SystemComponentType__OclElement = new ExecutorFragment(Types._SystemComponentType, OCLstdlibTables.Types._OclElement);
		private static final ExecutorFragment _SystemComponentType__OclEnumeration = new ExecutorFragment(Types._SystemComponentType, OCLstdlibTables.Types._OclEnumeration);
		private static final ExecutorFragment _SystemComponentType__OclType = new ExecutorFragment(Types._SystemComponentType, OCLstdlibTables.Types._OclType);
		private static final ExecutorFragment _SystemComponentType__SystemComponentType = new ExecutorFragment(Types._SystemComponentType, PasysTables.Types._SystemComponentType);
		...
		private static final ExecutorFragment _SystemElementAdapter__OclAny = new ExecutorFragment(Types._SystemElementAdapter, OCLstdlibTables.Types._OclAny);
		private static final ExecutorFragment _SystemElementAdapter__OclElement = new ExecutorFragment(Types._SystemElementAdapter, OCLstdlibTables.Types._OclElement);
		private static final ExecutorFragment _SystemElementAdapter__SystemElementAdapter = new ExecutorFragment(Types._SystemElementAdapter, PasysTables.Types._SystemElementAdapter);

		private static final ExecutorFragment _SystemExternalElement__NamedElement = new ExecutorFragment(Types._SystemExternalElement, PasysTables.Types._NamedElement);
		private static final ExecutorFragment _SystemExternalElement__OclAny = new ExecutorFragment(Types._SystemExternalElement, OCLstdlibTables.Types._OclAny);
		private static final ExecutorFragment _SystemExternalElement__OclElement = new ExecutorFragment(Types._SystemExternalElement, OCLstdlibTables.Types._OclElement);
		private static final ExecutorFragment _SystemExternalElement__SystemElement = new ExecutorFragment(Types._SystemExternalElement, PasysTables.Types._SystemElement);
		private static final ExecutorFragment _SystemExternalElement__SystemExternalElement = new ExecutorFragment(Types._SystemExternalElement, PasysTables.Types._SystemExternalElement);
	...
	public static class Operations {
		...
		public static final ExecutorOperation _NodeCluster__getNodes = new ExecutorOperation("getNodes", TypeUtil.EMPTY_PARAMETER_TYPES, Types._NodeCluster,
			0, TemplateParameters.EMPTY_LIST, null);
	...
	public static class Properties {
		...
		public static final ExecutorProperty _CassandraService__isSeed = new EcoreExecutorProperty(PasysPackage.Literals.CASSANDRA_SERVICE__IS_SEED, Types._CassandraService, 5);
		public static final ExecutorProperty _CassandraService__nativeTransportPort = new EcoreExecutorProperty(PasysPackage.Literals.CASSANDRA_SERVICE__NATIVE_TRANSPORT_PORT, Types._CassandraService, 6);
		public static final ExecutorProperty _CassandraService__numTokens = new EcoreExecutorProperty(PasysPackage.Literals.CASSANDRA_SERVICE__NUM_TOKENS, Types._CassandraService, 7);
		public static final ExecutorProperty _CassandraService__rack = new EcoreExecutorProperty(PasysPackage.Literals.CASSANDRA_SERVICE__RACK, Types._CassandraService, 8);
		public static final ExecutorProperty _CassandraService__seedProviderClass = new EcoreExecutorProperty(PasysPackage.Literals.CASSANDRA_SERVICE__SEED_PROVIDER_CLASS, Types._CassandraService, 9);
		public static final ExecutorProperty _CassandraService__seeds = new EcoreExecutorProperty(PasysPackage.Literals.CASSANDRA_SERVICE__SEEDS, Types._CassandraService, 10);
		...
		public static final ExecutorProperty _ComputationalSystem__referencedSystems = new EcoreExecutorProperty(PasysPackage.Literals.COMPUTATIONAL_SYSTEM__REFERENCED_SYSTEMS, Types._ComputationalSystem, 6);
		public static final ExecutorProperty _ComputationalSystem__targetPlatformName = new EcoreExecutorProperty(PasysPackage.Literals.COMPUTATIONAL_SYSTEM__TARGET_PLATFORM_NAME, Types._ComputationalSystem, 7);
		...
		public static final ExecutorProperty _DeploymentConstraints__OrchestrationServiceDeploymentConf__constraints = new ExecutorPropertyWithImplementation("OrchestrationServiceDeploymentConf", Types._DeploymentConstraints, 2, new EcoreLibraryOppositeProperty(PasysPackage.Literals.ORCHESTRATION_SERVICE_DEPLOYMENT_CONF__CONSTRAINTS));
		...
		public static final ExecutorProperty _KubernetesPort__name = new EcoreExecutorProperty(PasysPackage.Literals.KUBERNETES_PORT__NAME, Types._KubernetesPort, 0);

		public static final ExecutorProperty _KubernetesService__apiVersion = new EcoreExecutorProperty(PasysPackage.Literals.KUBERNETES_SERVICE__API_VERSION, Types._KubernetesService, 0);
		...
		public static final ExecutorProperty _NodeClusterDeploymentConf__artifactName = new EcoreExecutorProperty(PasysPackage.Literals.NODE_CLUSTER_DEPLOYMENT_CONF__ARTIFACT_NAME, Types._NodeClusterDeploymentConf, 2);
		public static final ExecutorProperty _NodeClusterDeploymentConf__configFolderPath = new EcoreExecutorProperty(PasysPackage.Literals.NODE_CLUSTER_DEPLOYMENT_CONF__CONFIG_FOLDER_PATH, Types._NodeClusterDeploymentConf, 3);
		public static final ExecutorProperty _NodeClusterDeploymentConf__dataFolderPath = new EcoreExecutorProperty(PasysPackage.Literals.NODE_CLUSTER_DEPLOYMENT_CONF__DATA_FOLDER_PATH, Types._NodeClusterDeploymentConf, 4);
		public static final ExecutorProperty _NodeClusterDeploymentConf__isRunning = new EcoreExecutorProperty(PasysPackage.Literals.NODE_CLUSTER_DEPLOYMENT_CONF__IS_RUNNING, Types._NodeClusterDeploymentConf, 5);
		public static final ExecutorProperty _NodeClusterDeploymentConf__logFolderPath = new EcoreExecutorProperty(PasysPackage.Literals.NODE_CLUSTER_DEPLOYMENT_CONF__LOG_FOLDER_PATH, Types._NodeClusterDeploymentConf, 6);
		public static final ExecutorProperty _NodeClusterDeploymentConf__scriptFolderPath = new EcoreExecutorProperty(PasysPackage.Literals.NODE_CLUSTER_DEPLOYMENT_CONF__SCRIPT_FOLDER_PATH, Types._NodeClusterDeploymentConf, 7);
		...
		public static final ExecutorProperty _OrchestrationService__PlatformService__orchestrator = new ExecutorPropertyWithImplementation("PlatformService", Types._OrchestrationService, 0, new EcoreLibraryOppositeProperty(PasysPackage.Literals.PLATFORM_SERVICE__ORCHESTRATOR));

		public static final ExecutorProperty _OrchestrationServiceDeploymentConf__command = new EcoreExecutorProperty(PasysPackage.Literals.ORCHESTRATION_SERVICE_DEPLOYMENT_CONF__COMMAND, Types._OrchestrationServiceDeploymentConf, 0);
		public static final ExecutorProperty _OrchestrationServiceDeploymentConf__constraints = new EcoreExecutorProperty(PasysPackage.Literals.ORCHESTRATION_SERVICE_DEPLOYMENT_CONF__CONSTRAINTS, Types._OrchestrationServiceDeploymentConf, 1);
		public static final ExecutorProperty _OrchestrationServiceDeploymentConf__image = new EcoreExecutorProperty(PasysPackage.Literals.ORCHESTRATION_SERVICE_DEPLOYMENT_CONF__IMAGE, Types._OrchestrationServiceDeploymentConf, 2);
		public static final ExecutorProperty _OrchestrationServiceDeploymentConf__imagePullPolicy = new EcoreExecutorProperty(PasysPackage.Literals.ORCHESTRATION_SERVICE_DEPLOYMENT_CONF__IMAGE_PULL_POLICY, Types._OrchestrationServiceDeploymentConf, 3);
		public static final ExecutorProperty _OrchestrationServiceDeploymentConf__ports = new EcoreExecutorProperty(PasysPackage.Literals.ORCHESTRATION_SERVICE_DEPLOYMENT_CONF__PORTS, Types._OrchestrationServiceDeploymentConf, 4);
		public static final ExecutorProperty _OrchestrationServiceDeploymentConf__replicas = new EcoreExecutorProperty(PasysPackage.Literals.ORCHESTRATION_SERVICE_DEPLOYMENT_CONF__REPLICAS, Types._OrchestrationServiceDeploymentConf, 5);
		public static final ExecutorProperty _OrchestrationServiceDeploymentConf__restartPolicy = new EcoreExecutorProperty(PasysPackage.Literals.ORCHESTRATION_SERVICE_DEPLOYMENT_CONF__RESTART_POLICY, Types._OrchestrationServiceDeploymentConf, 6);
		public static final ExecutorProperty _OrchestrationServiceDeploymentConf__volumes = new EcoreExecutorProperty(PasysPackage.Literals.ORCHESTRATION_SERVICE_DEPLOYMENT_CONF__VOLUMES, Types._OrchestrationServiceDeploymentConf, 7);
		...
		public static final ExecutorProperty _PlatformResource__ResourceCluster__resources = new ExecutorPropertyWithImplementation("ResourceCluster", Types._PlatformResource, 0, new EcoreLibraryOppositeProperty(PasysPackage.Literals.RESOURCE_CLUSTER__RESOURCES));
		...
		public static final ExecutorProperty _PlatformService__orchestrator = new EcoreExecutorProperty(PasysPackage.Literals.PLATFORM_SERVICE__ORCHESTRATOR, Types._PlatformService, 1);
		...
		public static final ExecutorProperty _Port__OrchestrationServiceDeploymentConf__ports = new ExecutorPropertyWithImplementation("OrchestrationServiceDeploymentConf", Types._Port, 2, new EcoreLibraryOppositeProperty(PasysPackage.Literals.ORCHESTRATION_SERVICE_DEPLOYMENT_CONF__PORTS));
		...
		public static final ExecutorProperty _ProcessingNode__configFiles = new EcoreExecutorProperty(PasysPackage.Literals.PROCESSING_NODE__CONFIG_FILES, Types._ProcessingNode, 2);
		public static final ExecutorProperty _ProcessingNode__connectedTo = new EcoreExecutorProperty(PasysPackage.Literals.PROCESSING_NODE__CONNECTED_TO, Types._ProcessingNode, 3);
		public static final ExecutorProperty _ProcessingNode__ip = new EcoreExecutorProperty(PasysPackage.Literals.PROCESSING_NODE__IP, Types._ProcessingNode, 4);
		public static final ExecutorProperty _ProcessingNode__launchingScripts = new EcoreExecutorProperty(PasysPackage.Literals.PROCESSING_NODE__LAUNCHING_SCRIPTS, Types._ProcessingNode, 5);
		public static final ExecutorProperty _ProcessingNode__memorySize = new EcoreExecutorProperty(PasysPackage.Literals.PROCESSING_NODE__MEMORY_SIZE, Types._ProcessingNode, 6);
		public static final ExecutorProperty _ProcessingNode__os = new EcoreExecutorProperty(PasysPackage.Literals.PROCESSING_NODE__OS, Types._ProcessingNode, 7);
		public static final ExecutorProperty _ProcessingNode__ownedMeters = new EcoreExecutorProperty(PasysPackage.Literals.PROCESSING_NODE__OWNED_METERS, Types._ProcessingNode, 8);
		public static final ExecutorProperty _ProcessingNode__propertyConfigData = new EcoreExecutorProperty(PasysPackage.Literals.PROCESSING_NODE__PROPERTY_CONFIG_DATA, Types._ProcessingNode, 9);
		...
		public static final ExecutorProperty _ProcessingNode__ProcessingNodeMemory__target = new ExecutorPropertyWithImplementation("ProcessingNodeMemory", Types._ProcessingNode, 12, new EcoreLibraryOppositeProperty(PasysPackage.Literals.PROCESSING_NODE_MEMORY__TARGET));
		public static final ExecutorProperty _ProcessingNode__ProcessingNodeUtilization__target = new ExecutorPropertyWithImplementation("ProcessingNodeUtilization", Types._ProcessingNode, 13, new EcoreLibraryOppositeProperty(PasysPackage.Literals.PROCESSING_NODE_UTILIZATION__TARGET));
		public static final ExecutorProperty _ProcessingNode__StreamDataPartition__host = new ExecutorPropertyWithImplementation("StreamDataPartition", Types._ProcessingNode, 14, new EcoreLibraryOppositeProperty(PasysPackage.Literals.STREAM_DATA_PARTITION__HOST));
		...
		public static final ExecutorProperty _ResourceCluster__resources = new EcoreExecutorProperty(PasysPackage.Literals.RESOURCE_CLUSTER__RESOURCES, Types._ResourceCluster, 0);
		public static final ExecutorProperty _ResourceCluster__CassandraService__rack = new ExecutorPropertyWithImplementation("CassandraService", Types._ResourceCluster, 1, new EcoreLibraryOppositeProperty(PasysPackage.Literals.CASSANDRA_SERVICE__RACK));
		public static final ExecutorProperty _ResourceCluster__SparkService__master = new ExecutorPropertyWithImplementation("SparkService", Types._ResourceCluster, 2, new EcoreLibraryOppositeProperty(PasysPackage.Literals.SPARK_SERVICE__MASTER));
		...
		public static final ExecutorProperty _StormService__isNimbus = new EcoreExecutorProperty(PasysPackage.Literals.STORM_SERVICE__IS_NIMBUS, Types._StormService, 0);
		public static final ExecutorProperty _StormService__localDir = new EcoreExecutorProperty(PasysPackage.Literals.STORM_SERVICE__LOCAL_DIR, Types._StormService, 1);
		public static final ExecutorProperty _StormService__nimbusSeeds = new EcoreExecutorProperty(PasysPackage.Literals.STORM_SERVICE__NIMBUS_SEEDS, Types._StormService, 2);
		public static final ExecutorProperty _StormService__supervisorSlotPorts = new EcoreExecutorProperty(PasysPackage.Literals.STORM_SERVICE__SUPERVISOR_SLOT_PORTS, Types._StormService, 3);
		public static final ExecutorProperty _StormService__uiPort = new EcoreExecutorProperty(PasysPackage.Literals.STORM_SERVICE__UI_PORT, Types._StormService, 4);
		public static final ExecutorProperty _StormService__zookeeperConnect = new EcoreExecutorProperty(PasysPackage.Literals.STORM_SERVICE__ZOOKEEPER_CONNECT, Types._StormService, 5);
		...
		public static final ExecutorProperty _SystemAdapter__elemMapping = new EcoreExecutorProperty(PasysPackage.Literals.SYSTEM_ADAPTER__ELEM_MAPPING, Types._SystemAdapter, 0);
		public static final ExecutorProperty _SystemAdapter__idPrefix = new EcoreExecutorProperty(PasysPackage.Literals.SYSTEM_ADAPTER__ID_PREFIX, Types._SystemAdapter, 1);
		public static final ExecutorProperty _SystemAdapter__prefix = new EcoreExecutorProperty(PasysPackage.Literals.SYSTEM_ADAPTER__PREFIX, Types._SystemAdapter, 2);
		public static final ExecutorProperty _SystemAdapter__systemTarget = new EcoreExecutorProperty(PasysPackage.Literals.SYSTEM_ADAPTER__SYSTEM_TARGET, Types._SystemAdapter, 3);
		public static final ExecutorProperty _SystemAdapter__targetSysLocator = new EcoreExecutorProperty(PasysPackage.Literals.SYSTEM_ADAPTER__TARGET_SYS_LOCATOR, Types._SystemAdapter, 4);
		...
		public static final ExecutorProperty _SystemElementAdapter__elemName = new EcoreExecutorProperty(PasysPackage.Literals.SYSTEM_ELEMENT_ADAPTER__ELEM_NAME, Types._SystemElementAdapter, 0);
		public static final ExecutorProperty _SystemElementAdapter__sourceElemId = new EcoreExecutorProperty(PasysPackage.Literals.SYSTEM_ELEMENT_ADAPTER__SOURCE_ELEM_ID, Types._SystemElementAdapter, 1);
		public static final ExecutorProperty _SystemElementAdapter__targetElemId = new EcoreExecutorProperty(PasysPackage.Literals.SYSTEM_ELEMENT_ADAPTER__TARGET_ELEM_ID, Types._SystemElementAdapter, 2);
		public static final ExecutorProperty _SystemElementAdapter__SystemAdapter__elemMapping = new ExecutorPropertyWithImplementation("SystemAdapter", Types._SystemElementAdapter, 3, new EcoreLibraryOppositeProperty(PasysPackage.Literals.SYSTEM_ADAPTER__ELEM_MAPPING));

		public static final ExecutorProperty _SystemExternalElement__elementType = new EcoreExecutorProperty(PasysPackage.Literals.SYSTEM_EXTERNAL_ELEMENT__ELEMENT_TYPE, Types._SystemExternalElement, 0);
		...
		public static final ExecutorProperty _Volume__OrchestrationServiceDeploymentConf__volumes = new ExecutorPropertyWithImplementation("OrchestrationServiceDeploymentConf", Types._Volume, 4, new EcoreLibraryOppositeProperty(PasysPackage.Literals.ORCHESTRATION_SERVICE_DEPLOYMENT_CONF__VOLUMES));
	...
	public static class TypeFragments {
		...
		private static final ExecutorFragment /*@NonNull*/ [] _ExternalElementType =
			{
				Fragments._ExternalElementType__OclAny /* 0 */,
				Fragments._ExternalElementType__OclElement /* 1 */,
				Fragments._ExternalElementType__OclType /* 2 */,
				Fragments._ExternalElementType__OclEnumeration /* 3 */,
				Fragments._ExternalElementType__ExternalElementType /* 4 */
			};
		private static final int /*@NonNull*/ [] __ExternalElementType = { 1,1,1,1,1 };
		...
		private static final ExecutorFragment /*@NonNull*/ [] _KubernetesPort =
			{
				...
				Fragments._KubernetesPort__KubernetesPort /* 2 */
			};
		private static final int /*@NonNull*/ [] __KubernetesPort = { 1,1,1 };

		private static final ExecutorFragment /*@NonNull*/ [] _KubernetesService =
			{
				Fragments._KubernetesService__OclAny /* 0 */,
				Fragments._KubernetesService__OclElement /* 1 */,
				Fragments._KubernetesService__DeployableComponent /* 2 */,
				Fragments._KubernetesService__NamedElement /* 2 */,
				Fragments._KubernetesService__SystemElement /* 3 */,
				Fragments._KubernetesService__PlatformResource /* 4 */,
				Fragments._KubernetesService__PlatformService /* 5 */,
				Fragments._KubernetesService__OrchestrationService /* 6 */,
				Fragments._KubernetesService__KubernetesService /* 7 */
			};
		private static final int /*@NonNull*/ [] __KubernetesService = { 1,1,2,1,1,1,1,1 };
		...
		private static final ExecutorFragment /*@NonNull*/ [] _NodeCluster =
			{
				Fragments._NodeCluster__OclAny /* 0 */,
				Fragments._NodeCluster__OclElement /* 1 */,
				Fragments._NodeCluster__NamedElement /* 2 */,
				Fragments._NodeCluster__SystemElement /* 3 */,
				Fragments._NodeCluster__PlatformResource /* 4 */,
				Fragments._NodeCluster__ResourceCluster /* 5 */,
				Fragments._NodeCluster__NodeCluster /* 6 */
			};
		private static final int /*@NonNull*/ [] __NodeCluster = { 1,1,1,1,1,1,1 };

		private static final ExecutorFragment /*@NonNull*/ [] _NodeClusterDeploymentConf =
			{
				Fragments._NodeClusterDeploymentConf__OclAny /* 0 */,
				Fragments._NodeClusterDeploymentConf__OclElement /* 1 */,
				Fragments._NodeClusterDeploymentConf__DeploymentConfiguration /* 2 */,
				Fragments._NodeClusterDeploymentConf__PlatformServiceDeploymentConf /* 3 */,
				Fragments._NodeClusterDeploymentConf__NodeClusterDeploymentConf /* 4 */
			};
		private static final int /*@NonNull*/ [] __NodeClusterDeploymentConf = { 1,1,1,1,1 };
		...
		private static final ExecutorFragment /*@NonNull*/ [] _OrchestrationService =
			{
				Fragments._OrchestrationService__OclAny /* 0 */,
				Fragments._OrchestrationService__OclElement /* 1 */,
				Fragments._OrchestrationService__DeployableComponent /* 2 */,
				Fragments._OrchestrationService__NamedElement /* 2 */,
				Fragments._OrchestrationService__SystemElement /* 3 */,
				Fragments._OrchestrationService__PlatformResource /* 4 */,
				Fragments._OrchestrationService__PlatformService /* 5 */,
				Fragments._OrchestrationService__OrchestrationService /* 6 */
			};
		private static final int /*@NonNull*/ [] __OrchestrationService = { 1,1,2,1,1,1,1 };

		private static final ExecutorFragment /*@NonNull*/ [] _OrchestrationServiceDeploymentConf =
			{
				Fragments._OrchestrationServiceDeploymentConf__OclAny /* 0 */,
				Fragments._OrchestrationServiceDeploymentConf__OclElement /* 1 */,
				Fragments._OrchestrationServiceDeploymentConf__DeploymentConfiguration /* 2 */,
				Fragments._OrchestrationServiceDeploymentConf__PlatformServiceDeploymentConf /* 3 */,
				Fragments._OrchestrationServiceDeploymentConf__OrchestrationServiceDeploymentConf /* 4 */
			};
		private static final int /*@NonNull*/ [] __OrchestrationServiceDeploymentConf = { 1,1,1,1,1 };
		...
		private static final ExecutorFragment /*@NonNull*/ [] _ResourceCluster =
			{
				Fragments._ResourceCluster__OclAny /* 0 */,
				Fragments._ResourceCluster__OclElement /* 1 */,
				Fragments._ResourceCluster__NamedElement /* 2 */,
				Fragments._ResourceCluster__SystemElement /* 3 */,
				Fragments._ResourceCluster__PlatformResource /* 4 */,
				Fragments._ResourceCluster__ResourceCluster /* 5 */
			};
		private static final int /*@NonNull*/ [] __ResourceCluster = { 1,1,1,1,1,1 };
		...
		private static final ExecutorFragment /*@NonNull*/ [] _SwarmService =
			{
				Fragments._SwarmService__OclAny /* 0 */,
				Fragments._SwarmService__OclElement /* 1 */,
				Fragments._SwarmService__DeployableComponent /* 2 */,
				Fragments._SwarmService__NamedElement /* 2 */,
				Fragments._SwarmService__SystemElement /* 3 */,
				Fragments._SwarmService__PlatformResource /* 4 */,
				Fragments._SwarmService__PlatformService /* 5 */,
				Fragments._SwarmService__OrchestrationService /* 6 */,
				Fragments._SwarmService__SwarmService /* 7 */
			};
		private static final int /*@NonNull*/ [] __SwarmService = { 1,1,2,1,1,1,1,1 };

		private static final ExecutorFragment /*@NonNull*/ [] _SystemAdapter =
			{
				Fragments._SystemAdapter__OclAny /* 0 */,
				Fragments._SystemAdapter__OclElement /* 1 */,
				Fragments._SystemAdapter__SystemAdapter /* 2 */
			};
		private static final int /*@NonNull*/ [] __SystemAdapter = { 1,1,1 };

		private static final ExecutorFragment /*@NonNull*/ [] _SystemComponentType =
			{
				Fragments._SystemComponentType__OclAny /* 0 */,
				Fragments._SystemComponentType__OclElement /* 1 */,
				Fragments._SystemComponentType__OclType /* 2 */,
				Fragments._SystemComponentType__OclEnumeration /* 3 */,
				Fragments._SystemComponentType__SystemComponentType /* 4 */
			};
		private static final int /*@NonNull*/ [] __SystemComponentType = { 1,1,1,1,1 };
		...
		private static final ExecutorFragment /*@NonNull*/ [] _SystemElementAdapter =
			{
				Fragments._SystemElementAdapter__OclAny /* 0 */,
				Fragments._SystemElementAdapter__OclElement /* 1 */,
				Fragments._SystemElementAdapter__SystemElementAdapter /* 2 */
			};
		private static final int /*@NonNull*/ [] __SystemElementAdapter = { 1,1,1 };

		private static final ExecutorFragment /*@NonNull*/ [] _SystemExternalElement =
			{
				Fragments._SystemExternalElement__OclAny /* 0 */,
				Fragments._SystemExternalElement__OclElement /* 1 */,
				Fragments._SystemExternalElement__NamedElement /* 2 */,
				Fragments._SystemExternalElement__SystemElement /* 3 */,
				Fragments._SystemExternalElement__SystemExternalElement /* 4 */
			};
		private static final int /*@NonNull*/ [] __SystemExternalElement = { 1,1,1,1,1 };
		...
		static {
			...
			Types._ExternalElementType.initFragments(_ExternalElementType, __ExternalElementType);
			...
			Types._KubernetesService.initFragments(_KubernetesService, __KubernetesService);
			...
			Types._NodeCluster.initFragments(_NodeCluster, __NodeCluster);
			Types._NodeClusterDeploymentConf.initFragments(_NodeClusterDeploymentConf, __NodeClusterDeploymentConf);
			...
			Types._OrchestrationService.initFragments(_OrchestrationService, __OrchestrationService);
			Types._OrchestrationServiceDeploymentConf.initFragments(_OrchestrationServiceDeploymentConf, __OrchestrationServiceDeploymentConf);
			...
			Types._ResourceCluster.initFragments(_ResourceCluster, __ResourceCluster);
			...
			Types._SwarmService.initFragments(_SwarmService, __SwarmService);
			Types._SystemAdapter.initFragments(_SystemAdapter, __SystemAdapter);
			Types._SystemComponentType.initFragments(_SystemComponentType, __SystemComponentType);
			Types._SystemElement.initFragments(_SystemElement, __SystemElement);
			Types._SystemElementAdapter.initFragments(_SystemElementAdapter, __SystemElementAdapter);
			Types._SystemExternalElement.initFragments(_SystemExternalElement, __SystemExternalElement);
	...
	public static class FragmentOperations {
		...
		private static final ExecutorOperation /*@NonNull*/ [] _ExternalElementType__ExternalElementType = {};
		private static final ExecutorOperation /*@NonNull*/ [] _ExternalElementType__OclAny = {
			OCLstdlibTables.Operations._OclAny___lt__gt_ /* _'<>'(OclSelf[?]) */,
			OCLstdlibTables.Operations._OclAny___eq_ /* _'='(OclSelf[?]) */,
			OCLstdlibTables.Operations._OclAny__oclAsSet /* oclAsSet() */,
			OCLstdlibTables.Operations._OclAny__oclAsType /* oclAsType(TT)(TT[1]) */,
		...
		private static final ExecutorOperation /*@NonNull*/ [] _ExternalElementType__OclElement = {
		...
		private static final ExecutorOperation /*@NonNull*/ [] _ExternalElementType__OclEnumeration = {
			OCLstdlibTables.Operations._OclEnumeration__allInstances /* allInstances() */
		};
		private static final ExecutorOperation /*@NonNull*/ [] _ExternalElementType__OclType = {
		...
		private static final ExecutorOperation /*@NonNull*/ [] _KubernetesService__KubernetesService = {};
		private static final ExecutorOperation /*@NonNull*/ [] _KubernetesService__DeployableComponent = {
			PasysTables.Operations._DeployableComponent__configureDeployment /* configureDeployment() */
		};
		private static final ExecutorOperation /*@NonNull*/ [] _KubernetesService__NamedElement = {};
		private static final ExecutorOperation /*@NonNull*/ [] _KubernetesService__OclAny = {
			OCLstdlibTables.Operations._OclAny___lt__gt_ /* _'<>'(OclSelf[?]) */,
			OCLstdlibTables.Operations._OclAny___eq_ /* _'='(OclSelf[?]) */,
			OCLstdlibTables.Operations._OclAny__oclAsSet /* oclAsSet() */,
			OCLstdlibTables.Operations._OclAny__oclAsType /* oclAsType(TT)(TT[1]) */,
		...
		private static final ExecutorOperation /*@NonNull*/ [] _KubernetesService__OclElement = {
			OCLstdlibTables.Operations._OclElement__allInstances /* allInstances() */,
			OCLstdlibTables.Operations._OclElement__oclAsModelType /* oclAsModelType(TT)(TT[1]) */,
			OCLstdlibTables.Operations._OclElement__oclContainer /* oclContainer() */,
			OCLstdlibTables.Operations._OclElement__oclContents /* oclContents() */,
		...
		private static final ExecutorOperation /*@NonNull*/ [] _KubernetesService__OrchestrationService = {};
		private static final ExecutorOperation /*@NonNull*/ [] _KubernetesService__PlatformResource = {};
		private static final ExecutorOperation /*@NonNull*/ [] _KubernetesService__PlatformService = {};
		private static final ExecutorOperation /*@NonNull*/ [] _KubernetesService__SystemElement = {};
		...
		private static final ExecutorOperation /*@NonNull*/ [] _NodeCluster__NodeCluster = {
			PasysTables.Operations._NodeCluster__getNodes /* getNodes() */
		};
		private static final ExecutorOperation /*@NonNull*/ [] _NodeCluster__NamedElement = {};
		private static final ExecutorOperation /*@NonNull*/ [] _NodeCluster__OclAny = {
			OCLstdlibTables.Operations._OclAny___lt__gt_ /* _'<>'(OclSelf[?]) */,
			OCLstdlibTables.Operations._OclAny___eq_ /* _'='(OclSelf[?]) */,
			OCLstdlibTables.Operations._OclAny__oclAsSet /* oclAsSet() */,
			OCLstdlibTables.Operations._OclAny__oclAsType /* oclAsType(TT)(TT[1]) */,
		...
		private static final ExecutorOperation /*@NonNull*/ [] _NodeCluster__OclElement = {
			OCLstdlibTables.Operations._OclElement__allInstances /* allInstances() */,
			OCLstdlibTables.Operations._OclElement__oclAsModelType /* oclAsModelType(TT)(TT[1]) */,
			OCLstdlibTables.Operations._OclElement__oclContainer /* oclContainer() */,
			OCLstdlibTables.Operations._OclElement__oclContents /* oclContents() */,
		...
		private static final ExecutorOperation /*@NonNull*/ [] _NodeCluster__PlatformResource = {};
		private static final ExecutorOperation /*@NonNull*/ [] _NodeCluster__ResourceCluster = {};
		private static final ExecutorOperation /*@NonNull*/ [] _NodeCluster__SystemElement = {};

		private static final ExecutorOperation /*@NonNull*/ [] _NodeClusterDeploymentConf__NodeClusterDeploymentConf = {};
		private static final ExecutorOperation /*@NonNull*/ [] _NodeClusterDeploymentConf__DeploymentConfiguration = {};
		private static final ExecutorOperation /*@NonNull*/ [] _NodeClusterDeploymentConf__OclAny = {
			OCLstdlibTables.Operations._OclAny___lt__gt_ /* _'<>'(OclSelf[?]) */,
			OCLstdlibTables.Operations._OclAny___eq_ /* _'='(OclSelf[?]) */,
			OCLstdlibTables.Operations._OclAny__oclAsSet /* oclAsSet() */,
			OCLstdlibTables.Operations._OclAny__oclAsType /* oclAsType(TT)(TT[1]) */,
		...
		private static final ExecutorOperation /*@NonNull*/ [] _NodeClusterDeploymentConf__OclElement = {
			OCLstdlibTables.Operations._OclElement__allInstances /* allInstances() */,
			OCLstdlibTables.Operations._OclElement__oclAsModelType /* oclAsModelType(TT)(TT[1]) */,
			OCLstdlibTables.Operations._OclElement__oclContainer /* oclContainer() */,
			OCLstdlibTables.Operations._OclElement__oclContents /* oclContents() */,
		...
		private static final ExecutorOperation /*@NonNull*/ [] _NodeClusterDeploymentConf__PlatformServiceDeploymentConf = {};
		...
		private static final ExecutorOperation /*@NonNull*/ [] _OrchestrationService__OrchestrationService = {};
		private static final ExecutorOperation /*@NonNull*/ [] _OrchestrationService__DeployableComponent = {
			PasysTables.Operations._DeployableComponent__configureDeployment /* configureDeployment() */
		};
		private static final ExecutorOperation /*@NonNull*/ [] _OrchestrationService__NamedElement = {};
		private static final ExecutorOperation /*@NonNull*/ [] _OrchestrationService__OclAny = {
			OCLstdlibTables.Operations._OclAny___lt__gt_ /* _'<>'(OclSelf[?]) */,
			OCLstdlibTables.Operations._OclAny___eq_ /* _'='(OclSelf[?]) */,
			OCLstdlibTables.Operations._OclAny__oclAsSet /* oclAsSet() */,
			OCLstdlibTables.Operations._OclAny__oclAsType /* oclAsType(TT)(TT[1]) */,
		...
		private static final ExecutorOperation /*@NonNull*/ [] _OrchestrationService__OclElement = {
			OCLstdlibTables.Operations._OclElement__allInstances /* allInstances() */,
			OCLstdlibTables.Operations._OclElement__oclAsModelType /* oclAsModelType(TT)(TT[1]) */,
			OCLstdlibTables.Operations._OclElement__oclContainer /* oclContainer() */,
			OCLstdlibTables.Operations._OclElement__oclContents /* oclContents() */,
		...
		private static final ExecutorOperation /*@NonNull*/ [] _OrchestrationService__PlatformResource = {};
		private static final ExecutorOperation /*@NonNull*/ [] _OrchestrationService__PlatformService = {};
		private static final ExecutorOperation /*@NonNull*/ [] _OrchestrationService__SystemElement = {};

		private static final ExecutorOperation /*@NonNull*/ [] _OrchestrationServiceDeploymentConf__OrchestrationServiceDeploymentConf = {};
		private static final ExecutorOperation /*@NonNull*/ [] _OrchestrationServiceDeploymentConf__DeploymentConfiguration = {};
		private static final ExecutorOperation /*@NonNull*/ [] _OrchestrationServiceDeploymentConf__OclAny = {
			OCLstdlibTables.Operations._OclAny___lt__gt_ /* _'<>'(OclSelf[?]) */,
			OCLstdlibTables.Operations._OclAny___eq_ /* _'='(OclSelf[?]) */,
			OCLstdlibTables.Operations._OclAny__oclAsSet /* oclAsSet() */,
			OCLstdlibTables.Operations._OclAny__oclAsType /* oclAsType(TT)(TT[1]) */,
		...
		private static final ExecutorOperation /*@NonNull*/ [] _OrchestrationServiceDeploymentConf__OclElement = {
			OCLstdlibTables.Operations._OclElement__allInstances /* allInstances() */,
			OCLstdlibTables.Operations._OclElement__oclAsModelType /* oclAsModelType(TT)(TT[1]) */,
			OCLstdlibTables.Operations._OclElement__oclContainer /* oclContainer() */,
			OCLstdlibTables.Operations._OclElement__oclContents /* oclContents() */,
		...
		private static final ExecutorOperation /*@NonNull*/ [] _OrchestrationServiceDeploymentConf__PlatformServiceDeploymentConf = {};
		...
		private static final ExecutorOperation /*@NonNull*/ [] _ResourceCluster__ResourceCluster = {};
		private static final ExecutorOperation /*@NonNull*/ [] _ResourceCluster__NamedElement = {};
		private static final ExecutorOperation /*@NonNull*/ [] _ResourceCluster__OclAny = {
			OCLstdlibTables.Operations._OclAny___lt__gt_ /* _'<>'(OclSelf[?]) */,
			OCLstdlibTables.Operations._OclAny___eq_ /* _'='(OclSelf[?]) */,
			OCLstdlibTables.Operations._OclAny__oclAsSet /* oclAsSet() */,
			OCLstdlibTables.Operations._OclAny__oclAsType /* oclAsType(TT)(TT[1]) */,
		...
		private static final ExecutorOperation /*@NonNull*/ [] _ResourceCluster__OclElement = {
			OCLstdlibTables.Operations._OclElement__allInstances /* allInstances() */,
			OCLstdlibTables.Operations._OclElement__oclAsModelType /* oclAsModelType(TT)(TT[1]) */,
			OCLstdlibTables.Operations._OclElement__oclContainer /* oclContainer() */,
			OCLstdlibTables.Operations._OclElement__oclContents /* oclContents() */,
		...
		private static final ExecutorOperation /*@NonNull*/ [] _ResourceCluster__PlatformResource = {};
		private static final ExecutorOperation /*@NonNull*/ [] _ResourceCluster__SystemElement = {};
		...
		private static final ExecutorOperation /*@NonNull*/ [] _SwarmService__SwarmService = {};
		private static final ExecutorOperation /*@NonNull*/ [] _SwarmService__DeployableComponent = {
			PasysTables.Operations._DeployableComponent__configureDeployment /* configureDeployment() */
		};
		private static final ExecutorOperation /*@NonNull*/ [] _SwarmService__NamedElement = {};
		private static final ExecutorOperation /*@NonNull*/ [] _SwarmService__OclAny = {
			OCLstdlibTables.Operations._OclAny___lt__gt_ /* _'<>'(OclSelf[?]) */,
			OCLstdlibTables.Operations._OclAny___eq_ /* _'='(OclSelf[?]) */,
			OCLstdlibTables.Operations._OclAny__oclAsSet /* oclAsSet() */,
			OCLstdlibTables.Operations._OclAny__oclAsType /* oclAsType(TT)(TT[1]) */,
		...
		private static final ExecutorOperation /*@NonNull*/ [] _SwarmService__OclElement = {
			OCLstdlibTables.Operations._OclElement__allInstances /* allInstances() */,
			OCLstdlibTables.Operations._OclElement__oclAsModelType /* oclAsModelType(TT)(TT[1]) */,
			OCLstdlibTables.Operations._OclElement__oclContainer /* oclContainer() */,
			OCLstdlibTables.Operations._OclElement__oclContents /* oclContents() */,
		...
		private static final ExecutorOperation /*@NonNull*/ [] _SwarmService__OrchestrationService = {};
		private static final ExecutorOperation /*@NonNull*/ [] _SwarmService__PlatformResource = {};
		private static final ExecutorOperation /*@NonNull*/ [] _SwarmService__PlatformService = {};
		private static final ExecutorOperation /*@NonNull*/ [] _SwarmService__SystemElement = {};

		private static final ExecutorOperation /*@NonNull*/ [] _SystemAdapter__SystemAdapter = {};
		private static final ExecutorOperation /*@NonNull*/ [] _SystemAdapter__OclAny = {
			OCLstdlibTables.Operations._OclAny___lt__gt_ /* _'<>'(OclSelf[?]) */,
			OCLstdlibTables.Operations._OclAny___eq_ /* _'='(OclSelf[?]) */,
			OCLstdlibTables.Operations._OclAny__oclAsSet /* oclAsSet() */,
			OCLstdlibTables.Operations._OclAny__oclAsType /* oclAsType(TT)(TT[1]) */,
		...
		private static final ExecutorOperation /*@NonNull*/ [] _SystemAdapter__OclElement = {
			OCLstdlibTables.Operations._OclElement__allInstances /* allInstances() */,
			OCLstdlibTables.Operations._OclElement__oclAsModelType /* oclAsModelType(TT)(TT[1]) */,
			OCLstdlibTables.Operations._OclElement__oclContainer /* oclContainer() */,
			OCLstdlibTables.Operations._OclElement__oclContents /* oclContents() */,
		...
		private static final ExecutorOperation /*@NonNull*/ [] _SystemComponentType__SystemComponentType = {};
		private static final ExecutorOperation /*@NonNull*/ [] _SystemComponentType__OclAny = {
			OCLstdlibTables.Operations._OclAny___lt__gt_ /* _'<>'(OclSelf[?]) */,
			OCLstdlibTables.Operations._OclAny___eq_ /* _'='(OclSelf[?]) */,
			OCLstdlibTables.Operations._OclAny__oclAsSet /* oclAsSet() */,
			OCLstdlibTables.Operations._OclAny__oclAsType /* oclAsType(TT)(TT[1]) */,
		...
		private static final ExecutorOperation /*@NonNull*/ [] _SystemComponentType__OclElement = {
			OCLstdlibTables.Operations._OclEnumeration__allInstances /* allInstances() */,
			OCLstdlibTables.Operations._OclElement__oclAsModelType /* oclAsModelType(TT)(TT[1]) */,
			OCLstdlibTables.Operations._OclElement__oclContainer /* oclContainer() */,
			OCLstdlibTables.Operations._OclElement__oclContents /* oclContents() */,
		...
		private static final ExecutorOperation /*@NonNull*/ [] _SystemComponentType__OclEnumeration = {
			OCLstdlibTables.Operations._OclEnumeration__allInstances /* allInstances() */
		};
		private static final ExecutorOperation /*@NonNull*/ [] _SystemComponentType__OclType = {
			OCLstdlibTables.Operations._OclType__conformsTo /* conformsTo(OclType[?]) */
		};
		...
		private static final ExecutorOperation /*@NonNull*/ [] _SystemElementAdapter__SystemElementAdapter = {};
		private static final ExecutorOperation /*@NonNull*/ [] _SystemElementAdapter__OclAny = {
			OCLstdlibTables.Operations._OclAny___lt__gt_ /* _'<>'(OclSelf[?]) */,
			OCLstdlibTables.Operations._OclAny___eq_ /* _'='(OclSelf[?]) */,
			OCLstdlibTables.Operations._OclAny__oclAsSet /* oclAsSet() */,
			OCLstdlibTables.Operations._OclAny__oclAsType /* oclAsType(TT)(TT[1]) */,
		...
		private static final ExecutorOperation /*@NonNull*/ [] _SystemElementAdapter__OclElement = {
			OCLstdlibTables.Operations._OclElement__allInstances /* allInstances() */,
			OCLstdlibTables.Operations._OclElement__oclAsModelType /* oclAsModelType(TT)(TT[1]) */,
			OCLstdlibTables.Operations._OclElement__oclContainer /* oclContainer() */,
			OCLstdlibTables.Operations._OclElement__oclContents /* oclContents() */,
		...
		private static final ExecutorOperation /*@NonNull*/ [] _SystemExternalElement__SystemExternalElement = {};
		private static final ExecutorOperation /*@NonNull*/ [] _SystemExternalElement__NamedElement = {};
		private static final ExecutorOperation /*@NonNull*/ [] _SystemExternalElement__OclAny = {
			OCLstdlibTables.Operations._OclAny___lt__gt_ /* _'<>'(OclSelf[?]) */,
			OCLstdlibTables.Operations._OclAny___eq_ /* _'='(OclSelf[?]) */,
			OCLstdlibTables.Operations._OclAny__oclAsSet /* oclAsSet() */,
			OCLstdlibTables.Operations._OclAny__oclAsType /* oclAsType(TT)(TT[1]) */,
		...
		private static final ExecutorOperation /*@NonNull*/ [] _SystemExternalElement__OclElement = {
			OCLstdlibTables.Operations._OclElement__allInstances /* allInstances() */,
			OCLstdlibTables.Operations._OclElement__oclAsModelType /* oclAsModelType(TT)(TT[1]) */,
			OCLstdlibTables.Operations._OclElement__oclContainer /* oclContainer() */,
			OCLstdlibTables.Operations._OclElement__oclContents /* oclContents() */,
		...
		private static final ExecutorOperation /*@NonNull*/ [] _SystemExternalElement__SystemElement = {};
		...
		static {
			...
			Fragments._ExternalElementType__ExternalElementType.initOperations(_ExternalElementType__ExternalElementType);
			Fragments._ExternalElementType__OclAny.initOperations(_ExternalElementType__OclAny);
			Fragments._ExternalElementType__OclElement.initOperations(_ExternalElementType__OclElement);
			Fragments._ExternalElementType__OclEnumeration.initOperations(_ExternalElementType__OclEnumeration);
			Fragments._ExternalElementType__OclType.initOperations(_ExternalElementType__OclType);
			...
			Fragments._KubernetesService__DeployableComponent.initOperations(_KubernetesService__DeployableComponent);
			Fragments._KubernetesService__KubernetesService.initOperations(_KubernetesService__KubernetesService);
			Fragments._KubernetesService__NamedElement.initOperations(_KubernetesService__NamedElement);
			Fragments._KubernetesService__OclAny.initOperations(_KubernetesService__OclAny);
			Fragments._KubernetesService__OclElement.initOperations(_KubernetesService__OclElement);
			Fragments._KubernetesService__OrchestrationService.initOperations(_KubernetesService__OrchestrationService);
			Fragments._KubernetesService__PlatformResource.initOperations(_KubernetesService__PlatformResource);
			Fragments._KubernetesService__PlatformService.initOperations(_KubernetesService__PlatformService);
			Fragments._KubernetesService__SystemElement.initOperations(_KubernetesService__SystemElement);
			...
			Fragments._NodeCluster__NamedElement.initOperations(_NodeCluster__NamedElement);
			Fragments._NodeCluster__NodeCluster.initOperations(_NodeCluster__NodeCluster);
			Fragments._NodeCluster__OclAny.initOperations(_NodeCluster__OclAny);
			Fragments._NodeCluster__OclElement.initOperations(_NodeCluster__OclElement);
			Fragments._NodeCluster__PlatformResource.initOperations(_NodeCluster__PlatformResource);
			Fragments._NodeCluster__ResourceCluster.initOperations(_NodeCluster__ResourceCluster);
			Fragments._NodeCluster__SystemElement.initOperations(_NodeCluster__SystemElement);

			Fragments._NodeClusterDeploymentConf__DeploymentConfiguration.initOperations(_NodeClusterDeploymentConf__DeploymentConfiguration);
			Fragments._NodeClusterDeploymentConf__NodeClusterDeploymentConf.initOperations(_NodeClusterDeploymentConf__NodeClusterDeploymentConf);
			Fragments._NodeClusterDeploymentConf__OclAny.initOperations(_NodeClusterDeploymentConf__OclAny);
			Fragments._NodeClusterDeploymentConf__OclElement.initOperations(_NodeClusterDeploymentConf__OclElement);
			Fragments._NodeClusterDeploymentConf__PlatformServiceDeploymentConf.initOperations(_NodeClusterDeploymentConf__PlatformServiceDeploymentConf);
			...
			Fragments._OrchestrationService__DeployableComponent.initOperations(_OrchestrationService__DeployableComponent);
			Fragments._OrchestrationService__NamedElement.initOperations(_OrchestrationService__NamedElement);
			Fragments._OrchestrationService__OclAny.initOperations(_OrchestrationService__OclAny);
			Fragments._OrchestrationService__OclElement.initOperations(_OrchestrationService__OclElement);
			Fragments._OrchestrationService__OrchestrationService.initOperations(_OrchestrationService__OrchestrationService);
			Fragments._OrchestrationService__PlatformResource.initOperations(_OrchestrationService__PlatformResource);
			Fragments._OrchestrationService__PlatformService.initOperations(_OrchestrationService__PlatformService);
			Fragments._OrchestrationService__SystemElement.initOperations(_OrchestrationService__SystemElement);

			Fragments._OrchestrationServiceDeploymentConf__DeploymentConfiguration.initOperations(_OrchestrationServiceDeploymentConf__DeploymentConfiguration);
			Fragments._OrchestrationServiceDeploymentConf__OclAny.initOperations(_OrchestrationServiceDeploymentConf__OclAny);
			Fragments._OrchestrationServiceDeploymentConf__OclElement.initOperations(_OrchestrationServiceDeploymentConf__OclElement);
			Fragments._OrchestrationServiceDeploymentConf__OrchestrationServiceDeploymentConf.initOperations(_OrchestrationServiceDeploymentConf__OrchestrationServiceDeploymentConf);
			Fragments._OrchestrationServiceDeploymentConf__PlatformServiceDeploymentConf.initOperations(_OrchestrationServiceDeploymentConf__PlatformServiceDeploymentConf);
			...
			Fragments._ResourceCluster__NamedElement.initOperations(_ResourceCluster__NamedElement);
			Fragments._ResourceCluster__OclAny.initOperations(_ResourceCluster__OclAny);
			Fragments._ResourceCluster__OclElement.initOperations(_ResourceCluster__OclElement);
			Fragments._ResourceCluster__PlatformResource.initOperations(_ResourceCluster__PlatformResource);
			Fragments._ResourceCluster__ResourceCluster.initOperations(_ResourceCluster__ResourceCluster);
			Fragments._ResourceCluster__SystemElement.initOperations(_ResourceCluster__SystemElement);
			...
			Fragments._SwarmService__DeployableComponent.initOperations(_SwarmService__DeployableComponent);
			Fragments._SwarmService__NamedElement.initOperations(_SwarmService__NamedElement);
			Fragments._SwarmService__OclAny.initOperations(_SwarmService__OclAny);
			Fragments._SwarmService__OclElement.initOperations(_SwarmService__OclElement);
			Fragments._SwarmService__OrchestrationService.initOperations(_SwarmService__OrchestrationService);
			Fragments._SwarmService__PlatformResource.initOperations(_SwarmService__PlatformResource);
			Fragments._SwarmService__PlatformService.initOperations(_SwarmService__PlatformService);
			Fragments._SwarmService__SwarmService.initOperations(_SwarmService__SwarmService);
			Fragments._SwarmService__SystemElement.initOperations(_SwarmService__SystemElement);

			Fragments._SystemAdapter__OclAny.initOperations(_SystemAdapter__OclAny);
			Fragments._SystemAdapter__OclElement.initOperations(_SystemAdapter__OclElement);
			Fragments._SystemAdapter__SystemAdapter.initOperations(_SystemAdapter__SystemAdapter);

			Fragments._SystemComponentType__OclAny.initOperations(_SystemComponentType__OclAny);
			Fragments._SystemComponentType__OclElement.initOperations(_SystemComponentType__OclElement);
			Fragments._SystemComponentType__OclEnumeration.initOperations(_SystemComponentType__OclEnumeration);
			Fragments._SystemComponentType__OclType.initOperations(_SystemComponentType__OclType);
			Fragments._SystemComponentType__SystemComponentType.initOperations(_SystemComponentType__SystemComponentType);
			...
			Fragments._SystemElementAdapter__OclAny.initOperations(_SystemElementAdapter__OclAny);
			Fragments._SystemElementAdapter__OclElement.initOperations(_SystemElementAdapter__OclElement);
			Fragments._SystemElementAdapter__SystemElementAdapter.initOperations(_SystemElementAdapter__SystemElementAdapter);

			Fragments._SystemExternalElement__NamedElement.initOperations(_SystemExternalElement__NamedElement);
			Fragments._SystemExternalElement__OclAny.initOperations(_SystemExternalElement__OclAny);
			Fragments._SystemExternalElement__OclElement.initOperations(_SystemExternalElement__OclElement);
			Fragments._SystemExternalElement__SystemElement.initOperations(_SystemExternalElement__SystemElement);
			Fragments._SystemExternalElement__SystemExternalElement.initOperations(_SystemExternalElement__SystemExternalElement);
	...
	public static class FragmentProperties {
		...
		private static final ExecutorProperty /*@NonNull*/ [] _AWSVirtualProcessingNode = {
			...
			PasysTables.Properties._SystemElement__owner,
			PasysTables.Properties._ProcessingNode__propertyConfigData,
		...
		private static final ExecutorProperty /*@NonNull*/ [] _CassandraService = {
			...
			PasysTables.Properties._PlatformService__host,
			PasysTables.Properties._NamedElement__id,
			PasysTables.Properties._CassandraService__isSeed,
			...
			PasysTables.Properties._CassandraService__rack,
		...
		private static final ExecutorProperty /*@NonNull*/ [] _ComputationalSystem = {
			...
			PasysTables.Properties._ComputationalSystem__referencedSystems,
		...
		private static final ExecutorProperty /*@NonNull*/ [] _ExternalElementType = {
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents
		};
		...
		private static final ExecutorProperty /*@NonNull*/ [] _KubernetesService = {
			PasysTables.Properties._KubernetesService__apiVersion,
			PasysTables.Properties._DeployableComponent__deploymentConfig,
			PasysTables.Properties._PlatformService__host,
			PasysTables.Properties._NamedElement__id,
			PasysTables.Properties._NamedElement__name,
		...
		private static final ExecutorProperty /*@NonNull*/ [] _NodeCluster = {
			PasysTables.Properties._NamedElement__id,
			PasysTables.Properties._NamedElement__name,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents,
			PasysTables.Properties._SystemElement__owner,
			PasysTables.Properties._ResourceCluster__resources
		};

		private static final ExecutorProperty /*@NonNull*/ [] _NodeClusterDeploymentConf = {
			PasysTables.Properties._NodeClusterDeploymentConf__arguments,
			PasysTables.Properties._NodeClusterDeploymentConf__artifactLocator,
			PasysTables.Properties._NodeClusterDeploymentConf__artifactName,
			PasysTables.Properties._NodeClusterDeploymentConf__configFolderPath,
			PasysTables.Properties._NodeClusterDeploymentConf__dataFolderPath,
			PasysTables.Properties._NodeClusterDeploymentConf__isRunning,
			PasysTables.Properties._NodeClusterDeploymentConf__logFolderPath,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents,
			PasysTables.Properties._NodeClusterDeploymentConf__scriptFolderPath
		};
		...
		private static final ExecutorProperty /*@NonNull*/ [] _OrchestrationService = {
			PasysTables.Properties._DeployableComponent__deploymentConfig,
			PasysTables.Properties._PlatformService__host,
			PasysTables.Properties._NamedElement__id,
			PasysTables.Properties._NamedElement__name,
		...
		private static final ExecutorProperty /*@NonNull*/ [] _OrchestrationServiceDeploymentConf = {
			PasysTables.Properties._OrchestrationServiceDeploymentConf__command,
			PasysTables.Properties._OrchestrationServiceDeploymentConf__constraints,
			PasysTables.Properties._OrchestrationServiceDeploymentConf__image,
			PasysTables.Properties._OrchestrationServiceDeploymentConf__imagePullPolicy,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents,
			PasysTables.Properties._OrchestrationServiceDeploymentConf__ports,
			PasysTables.Properties._OrchestrationServiceDeploymentConf__replicas,
			PasysTables.Properties._OrchestrationServiceDeploymentConf__restartPolicy,
			PasysTables.Properties._OrchestrationServiceDeploymentConf__volumes
		};
		...
		private static final ExecutorProperty /*@NonNull*/ [] _ResourceCluster = {
			PasysTables.Properties._NamedElement__id,
			PasysTables.Properties._NamedElement__name,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents,
		...
		private static final ExecutorProperty /*@NonNull*/ [] _StormService = {
			...
			PasysTables.Properties._PlatformService__host,
			PasysTables.Properties._NamedElement__id,
			PasysTables.Properties._StormService__isNimbus,
		...
		private static final ExecutorProperty /*@NonNull*/ [] _SwarmService = {
			PasysTables.Properties._DeployableComponent__deploymentConfig,
			PasysTables.Properties._PlatformService__host,
			PasysTables.Properties._NamedElement__id,
			PasysTables.Properties._NamedElement__name,
		...
		private static final ExecutorProperty /*@NonNull*/ [] _SystemAdapter = {
			PasysTables.Properties._SystemAdapter__elemMapping,
			PasysTables.Properties._SystemAdapter__idPrefix,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents,
			PasysTables.Properties._SystemAdapter__prefix,
			PasysTables.Properties._SystemAdapter__systemTarget,
			PasysTables.Properties._SystemAdapter__targetSysLocator
		};

		private static final ExecutorProperty /*@NonNull*/ [] _SystemComponentType = {
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents
		};
		...
		private static final ExecutorProperty /*@NonNull*/ [] _SystemElementAdapter = {
			PasysTables.Properties._SystemElementAdapter__elemName,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents,
			PasysTables.Properties._SystemElementAdapter__sourceElemId,
			PasysTables.Properties._SystemElementAdapter__targetElemId
		};

		private static final ExecutorProperty /*@NonNull*/ [] _SystemExternalElement = {
			PasysTables.Properties._SystemExternalElement__elementType,
			PasysTables.Properties._NamedElement__id,
			PasysTables.Properties._NamedElement__name,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents,
		...
		static {
			...
			Fragments._ExternalElementType__ExternalElementType.initProperties(_ExternalElementType);
			...
			Fragments._KubernetesService__KubernetesService.initProperties(_KubernetesService);
			...
			Fragments._NodeCluster__NodeCluster.initProperties(_NodeCluster);
			Fragments._NodeClusterDeploymentConf__NodeClusterDeploymentConf.initProperties(_NodeClusterDeploymentConf);
			...
			Fragments._OrchestrationService__OrchestrationService.initProperties(_OrchestrationService);
			Fragments._OrchestrationServiceDeploymentConf__OrchestrationServiceDeploymentConf.initProperties(_OrchestrationServiceDeploymentConf);
			...
			Fragments._ResourceCluster__ResourceCluster.initProperties(_ResourceCluster);
			...
			Fragments._SwarmService__SwarmService.initProperties(_SwarmService);
			Fragments._SystemAdapter__SystemAdapter.initProperties(_SystemAdapter);
			Fragments._SystemComponentType__SystemComponentType.initProperties(_SystemComponentType);
			Fragments._SystemElement__SystemElement.initProperties(_SystemElement);
			Fragments._SystemElementAdapter__SystemElementAdapter.initProperties(_SystemElementAdapter);
			Fragments._SystemExternalElement__SystemExternalElement.initProperties(_SystemExternalElement);
	...
	public static class EnumerationLiterals {
		...
		public static final EcoreExecutorEnumerationLiteral _ExternalElementType__PROCESSING_NODE = new EcoreExecutorEnumerationLiteral(PasysPackage.Literals.EXTERNAL_ELEMENT_TYPE.getEEnumLiteral("PROCESSING_NODE"), Types._ExternalElementType, 0);
		public static final EcoreExecutorEnumerationLiteral _ExternalElementType__COMMUNICATION_SERVER = new EcoreExecutorEnumerationLiteral(PasysPackage.Literals.EXTERNAL_ELEMENT_TYPE.getEEnumLiteral("COMMUNICATION_SERVER"), Types._ExternalElementType, 1);
		public static final EcoreExecutorEnumerationLiteral _ExternalElementType__SCHEDULING_SERVER = new EcoreExecutorEnumerationLiteral(PasysPackage.Literals.EXTERNAL_ELEMENT_TYPE.getEEnumLiteral("SCHEDULING_SERVER"), Types._ExternalElementType, 2);
		public static final EcoreExecutorEnumerationLiteral _ExternalElementType__NODE_CLUSTER = new EcoreExecutorEnumerationLiteral(PasysPackage.Literals.EXTERNAL_ELEMENT_TYPE.getEEnumLiteral("NODE_CLUSTER"), Types._ExternalElementType, 3);
		public static final EcoreExecutorEnumerationLiteral _ExternalElementType__PLATFORM_RESOURCE = new EcoreExecutorEnumerationLiteral(PasysPackage.Literals.EXTERNAL_ELEMENT_TYPE.getEEnumLiteral("PLATFORM_RESOURCE"), Types._ExternalElementType, 4);
		public static final EcoreExecutorEnumerationLiteral _ExternalElementType__WORKFLOW = new EcoreExecutorEnumerationLiteral(PasysPackage.Literals.EXTERNAL_ELEMENT_TYPE.getEEnumLiteral("WORKFLOW"), Types._ExternalElementType, 5);
		public static final EcoreExecutorEnumerationLiteral _ExternalElementType__SCHEDULABLE_SET = new EcoreExecutorEnumerationLiteral(PasysPackage.Literals.EXTERNAL_ELEMENT_TYPE.getEEnumLiteral("SCHEDULABLE_SET"), Types._ExternalElementType, 6);
		public static final EcoreExecutorEnumerationLiteral _ExternalElementType__TASK = new EcoreExecutorEnumerationLiteral(PasysPackage.Literals.EXTERNAL_ELEMENT_TYPE.getEEnumLiteral("TASK"), Types._ExternalElementType, 7);
		private static final EcoreExecutorEnumerationLiteral /*@NonNull*/ [] _ExternalElementType = {
			_ExternalElementType__PROCESSING_NODE,
			_ExternalElementType__COMMUNICATION_SERVER,
			_ExternalElementType__SCHEDULING_SERVER,
			_ExternalElementType__NODE_CLUSTER,
			_ExternalElementType__PLATFORM_RESOURCE,
			_ExternalElementType__WORKFLOW,
			_ExternalElementType__SCHEDULABLE_SET,
			_ExternalElementType__TASK
		};
		...
		public static final EcoreExecutorEnumerationLiteral _SystemComponentType__PROMETHEUS_SERVER = new EcoreExecutorEnumerationLiteral(PasysPackage.Literals.SYSTEM_COMPONENT_TYPE.getEEnumLiteral("PROMETHEUS_SERVER"), Types._SystemComponentType, 0);
		public static final EcoreExecutorEnumerationLiteral _SystemComponentType__ZOOKEEPER_SERVER = new EcoreExecutorEnumerationLiteral(PasysPackage.Literals.SYSTEM_COMPONENT_TYPE.getEEnumLiteral("ZOOKEEPER_SERVER"), Types._SystemComponentType, 1);
		public static final EcoreExecutorEnumerationLiteral _SystemComponentType__KAFKA_SERVER = new EcoreExecutorEnumerationLiteral(PasysPackage.Literals.SYSTEM_COMPONENT_TYPE.getEEnumLiteral("KAFKA_SERVER"), Types._SystemComponentType, 2);
		public static final EcoreExecutorEnumerationLiteral _SystemComponentType__CASSANDRA_SERVER_SEED = new EcoreExecutorEnumerationLiteral(PasysPackage.Literals.SYSTEM_COMPONENT_TYPE.getEEnumLiteral("CASSANDRA_SERVER_SEED"), Types._SystemComponentType, 3);
		public static final EcoreExecutorEnumerationLiteral _SystemComponentType__CASSANDRA_SERVER = new EcoreExecutorEnumerationLiteral(PasysPackage.Literals.SYSTEM_COMPONENT_TYPE.getEEnumLiteral("CASSANDRA_SERVER"), Types._SystemComponentType, 4);
		public static final EcoreExecutorEnumerationLiteral _SystemComponentType__STORM_NIMBUS = new EcoreExecutorEnumerationLiteral(PasysPackage.Literals.SYSTEM_COMPONENT_TYPE.getEEnumLiteral("STORM_NIMBUS"), Types._SystemComponentType, 5);
		public static final EcoreExecutorEnumerationLiteral _SystemComponentType__STORM_SUPERVISOR = new EcoreExecutorEnumerationLiteral(PasysPackage.Literals.SYSTEM_COMPONENT_TYPE.getEEnumLiteral("STORM_SUPERVISOR"), Types._SystemComponentType, 6);
		public static final EcoreExecutorEnumerationLiteral _SystemComponentType__SPARK_SERVER = new EcoreExecutorEnumerationLiteral(PasysPackage.Literals.SYSTEM_COMPONENT_TYPE.getEEnumLiteral("SPARK_SERVER"), Types._SystemComponentType, 7);
		public static final EcoreExecutorEnumerationLiteral _SystemComponentType__KAFKA_WORKLOAD_STREAM = new EcoreExecutorEnumerationLiteral(PasysPackage.Literals.SYSTEM_COMPONENT_TYPE.getEEnumLiteral("KAFKA_WORKLOAD_STREAM"), Types._SystemComponentType, 8);
		public static final EcoreExecutorEnumerationLiteral _SystemComponentType__KAFKA_FLOW_STREAM = new EcoreExecutorEnumerationLiteral(PasysPackage.Literals.SYSTEM_COMPONENT_TYPE.getEEnumLiteral("KAFKA_FLOW_STREAM"), Types._SystemComponentType, 9);
		public static final EcoreExecutorEnumerationLiteral _SystemComponentType__AVRO_SERVER = new EcoreExecutorEnumerationLiteral(PasysPackage.Literals.SYSTEM_COMPONENT_TYPE.getEEnumLiteral("AVRO_SERVER"), Types._SystemComponentType, 10);
		public static final EcoreExecutorEnumerationLiteral _SystemComponentType__NODE_RESOURCE_METER = new EcoreExecutorEnumerationLiteral(PasysPackage.Literals.SYSTEM_COMPONENT_TYPE.getEEnumLiteral("NODE_RESOURCE_METER"), Types._SystemComponentType, 11);
		public static final EcoreExecutorEnumerationLiteral _SystemComponentType__TASK_EXECUTOR = new EcoreExecutorEnumerationLiteral(PasysPackage.Literals.SYSTEM_COMPONENT_TYPE.getEEnumLiteral("TASK_EXECUTOR"), Types._SystemComponentType, 12);
		public static final EcoreExecutorEnumerationLiteral _SystemComponentType__TASK_AMOUNT_METER = new EcoreExecutorEnumerationLiteral(PasysPackage.Literals.SYSTEM_COMPONENT_TYPE.getEEnumLiteral("TASK_AMOUNT_METER"), Types._SystemComponentType, 13);
		public static final EcoreExecutorEnumerationLiteral _SystemComponentType__DOCKER_STACK = new EcoreExecutorEnumerationLiteral(PasysPackage.Literals.SYSTEM_COMPONENT_TYPE.getEEnumLiteral("DOCKER_STACK"), Types._SystemComponentType, 14);
		public static final EcoreExecutorEnumerationLiteral _SystemComponentType__WORKFLOW = new EcoreExecutorEnumerationLiteral(PasysPackage.Literals.SYSTEM_COMPONENT_TYPE.getEEnumLiteral("WORKFLOW"), Types._SystemComponentType, 15);
		public static final EcoreExecutorEnumerationLiteral _SystemComponentType__CASSANDRA_SCHEMA = new EcoreExecutorEnumerationLiteral(PasysPackage.Literals.SYSTEM_COMPONENT_TYPE.getEEnumLiteral("CASSANDRA_SCHEMA"), Types._SystemComponentType, 16);
		private static final EcoreExecutorEnumerationLiteral /*@NonNull*/ [] _SystemComponentType = {
			_SystemComponentType__PROMETHEUS_SERVER,
			_SystemComponentType__ZOOKEEPER_SERVER,
			_SystemComponentType__KAFKA_SERVER,
			_SystemComponentType__CASSANDRA_SERVER_SEED,
			_SystemComponentType__CASSANDRA_SERVER,
			_SystemComponentType__STORM_NIMBUS,
			_SystemComponentType__STORM_SUPERVISOR,
			_SystemComponentType__SPARK_SERVER,
			_SystemComponentType__KAFKA_WORKLOAD_STREAM,
			_SystemComponentType__KAFKA_FLOW_STREAM,
			_SystemComponentType__AVRO_SERVER,
			_SystemComponentType__NODE_RESOURCE_METER,
			_SystemComponentType__TASK_EXECUTOR,
			_SystemComponentType__TASK_AMOUNT_METER,
			_SystemComponentType__DOCKER_STACK,
			_SystemComponentType__WORKFLOW,
			_SystemComponentType__CASSANDRA_SCHEMA
		};
		 ...
		 */
		static {
			Types._ExternalElementType.initLiterals(_ExternalElementType);
			Types._PortMode.initLiterals(_PortMode);
			Types._Protocol.initLiterals(_Protocol);
			Types._SystemComponentType.initLiterals(_SystemComponentType);
