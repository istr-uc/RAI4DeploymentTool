...
public class PasysTables extends AbstractTables
{
	...
	public static class Properties {
		...
		public static final ExecutorProperty _ResourceCluster__SparkService__master = new ExecutorPropertyWithImplementation("SparkService", Types._ResourceCluster, 1, new EcoreLibraryOppositeProperty(PasysPackage.Literals.SPARK_SERVICE__MASTER));
